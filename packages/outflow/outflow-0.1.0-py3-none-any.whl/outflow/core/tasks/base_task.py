...
class BaseTask(metaclass=TaskMeta):
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        cls._targets_definition = {"inputs": [], "outputs": [], "parameters": []}
        cls._inputs = None
        cls._outputs = None
    ...
    @classmethod
    def add_parameter(cls, target_class, identifier):
        cls._targets_definition["parameters"].append((target_class, identifier))
    ...
    def as_task(
        ...
        *,
        ...
        Args:
            ...
            with_context (bool): If true, the run function will be called as a
        ...
        if run_func is None:
            ...
            task_class = type(
                to_camel_case(name),
                (cls,),
                {"run": run_func, "parallel": parallel, "with_context": with_context},
            )
    ...
    def inputs(self):
        ...
        if self._inputs is None:
            self._inputs = {}
            for target_class, identifier, args, kwargs in self._targets_definition[
                "inputs"
            ]:
                self._inputs[identifier] = (target_class, args, kwargs)
    ...
    def outputs(self):
        ...
        if self._outputs is None:
            ...
            for target_class, identifier, args, kwargs in self._targets_definition[
                ...
                self._outputs[identifier] = target_class
    ...
    def parameters(self):
        ...
        if self._parameters is None:
            self._parameters = {}
            for target_class, identifier in self._targets_definition["parameters"]:
                self._parameters[identifier] = target_class
