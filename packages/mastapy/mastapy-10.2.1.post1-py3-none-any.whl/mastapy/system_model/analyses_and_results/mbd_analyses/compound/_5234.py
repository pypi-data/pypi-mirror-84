...
class PlanetaryConnectionCompoundMultiBodyDynamicsAnalysis(_5246.ShaftToMountableComponentConnectionCompoundMultiBodyDynamicsAnalysis):
    '''PlanetaryConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5101.PlanetaryConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5101.PlanetaryConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5101.PlanetaryConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5101.PlanetaryConnectionMultiBodyDynamicsAnalysis))
        return value
