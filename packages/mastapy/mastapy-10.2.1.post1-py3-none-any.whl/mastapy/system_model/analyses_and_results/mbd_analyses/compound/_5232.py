...
class PartToPartShearCouplingConnectionCompoundMultiBodyDynamicsAnalysis(_5193.CouplingConnectionCompoundMultiBodyDynamicsAnalysis):
    '''PartToPartShearCouplingConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5098.PartToPartShearCouplingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5098.PartToPartShearCouplingConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5098.PartToPartShearCouplingConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5098.PartToPartShearCouplingConnectionMultiBodyDynamicsAnalysis))
        return value
