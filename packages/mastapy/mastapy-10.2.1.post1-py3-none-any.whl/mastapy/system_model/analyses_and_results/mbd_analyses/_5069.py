...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5068, _5066, _5117
...
class GearSetMultiBodyDynamicsAnalysis(_5117.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def assembly_design(self) -> '_2114.GearSet':
    ...
    @property
    def gears(self) -> 'List[_5068.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5068.GearMultiBodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5066.GearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5066.GearMeshMultiBodyDynamicsAnalysis))
        return value
