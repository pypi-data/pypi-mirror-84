...
class BeltConnectionMultiBodyDynamicsAnalysis(_5058.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1384.LoadingStatus':
        ...
        return constructor.new(_1384.LoadingStatus)(value) if value else None
