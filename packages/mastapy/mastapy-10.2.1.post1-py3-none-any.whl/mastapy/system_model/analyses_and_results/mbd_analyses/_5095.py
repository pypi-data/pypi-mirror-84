...
from mastapy.nodal_analysis.system_solvers import (
    _1439, _1421, _1422, _1425,
    _1426, _1427, _1428, _1429,
    _1430, _1431, _1432, _1437,
    _1440
)
...
class MultiBodyDynamicsAnalysis(_6548.TimeSeriesLoadAnalysisCase):
    '''MultiBodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5091.MBDAnalysisOptions':
        ...
        return constructor.new(_5091.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None

    @property
    def transient_solver(self) -> '_1439.TransientSolver':
        ...
        if _1439.TransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_acceleration_step_halving_transient_solver(self) -> '_1421.BackwardEulerAccelerationStepHalvingTransientSolver':
        ...
        if _1421.BackwardEulerAccelerationStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_transient_solver(self) -> '_1422.BackwardEulerTransientSolver':
        ...
        if _1422.BackwardEulerTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_internal_transient_solver(self) -> '_1425.InternalTransientSolver':
        ...
        if _1425.InternalTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiia_transient_solver(self) -> '_1426.LobattoIIIATransientSolver':
        ...
        if _1426.LobattoIIIATransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiic_transient_solver(self) -> '_1427.LobattoIIICTransientSolver':
        ...
        if _1427.LobattoIIICTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_acceleration_transient_solver(self) -> '_1428.NewmarkAccelerationTransientSolver':
        ...
        if _1428.NewmarkAccelerationTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_transient_solver(self) -> '_1429.NewmarkTransientSolver':
        ...
        if _1429.NewmarkTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_semi_implicit_transient_solver(self) -> '_1430.SemiImplicitTransientSolver':
        ...
        if _1430.SemiImplicitTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_acceleration_based_step_halving_transient_solver(self) -> '_1431.SimpleAccelerationBasedStepHalvingTransientSolver':
        ...
        if _1431.SimpleAccelerationBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_velocity_based_step_halving_transient_solver(self) -> '_1432.SimpleVelocityBasedStepHalvingTransientSolver':
        ...
        if _1432.SimpleVelocityBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_step_halving_transient_solver(self) -> '_1437.StepHalvingTransientSolver':
        ...
        if _1437.StepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_wilson_theta_transient_solver(self) -> '_1440.WilsonThetaTransientSolver':
        ...
        if _1440.WilsonThetaTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
