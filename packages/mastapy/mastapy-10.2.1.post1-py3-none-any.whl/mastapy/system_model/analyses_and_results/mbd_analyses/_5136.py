...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5140, _5050
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5050.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5140.TorqueConverterStatus':
        ...
        return constructor.new(_5140.TorqueConverterStatus)(value) if value else None
