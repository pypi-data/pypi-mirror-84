...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5891, _5850
...
class RootAssemblyDynamicAnalysis(_5850.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_5891.DynamicAnalysis':
        ...
        if _5891.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
