...
class PartDynamicAnalysis(_6544.PartFEAnalysis):
    '''PartDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5891.DynamicAnalysis':
        ...
        if _5891.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
