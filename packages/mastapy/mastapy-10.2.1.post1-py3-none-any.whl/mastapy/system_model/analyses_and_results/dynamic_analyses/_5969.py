...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5967, _5968, _5863
...
class ZerolBevelGearSetDynamicAnalysis(_5863.BevelGearSetDynamicAnalysis):
    '''ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_5967.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsDynamicAnalysis, constructor.new(_5967.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_5968.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesDynamicAnalysis, constructor.new(_5968.ZerolBevelGearMeshDynamicAnalysis))
        return value
