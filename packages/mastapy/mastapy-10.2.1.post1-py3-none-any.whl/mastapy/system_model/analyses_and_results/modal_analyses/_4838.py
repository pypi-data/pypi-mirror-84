...
from mastapy.system_model.analyses_and_results.modal_analyses import _4818, _4750
...
class RootAssemblyModalAnalysis(_4750.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_4818.ModalAnalysis':
        ...
        if _4818.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
