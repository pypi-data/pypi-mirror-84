...
class ConceptCouplingConnectionModalAnalysis(_4781.CouplingConnectionModalAnalysis):
    '''ConceptCouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2276.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2276.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
