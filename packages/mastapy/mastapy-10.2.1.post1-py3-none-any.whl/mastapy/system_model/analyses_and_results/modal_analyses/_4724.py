...
from mastapy.system_model.analyses_and_results.modal_analyses import _4747, _4777, _4804
...
class AbstractAssemblyModalAnalysis(_4804.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4747.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4747.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4777.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4777.GearMeshModalAnalysis))
        return value
