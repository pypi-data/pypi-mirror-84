...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4889
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2286, _2253, _2258, _2260,
    _2265, _2270, _2273, _2276,
    _2279, _2283, _2288, _2291,
    _2294, _2295, _2296, _2307,
    _2311, _2315, _2319, _2320,
    _2323, _2326, _2338, _2341,
    _2347, _2354, _2356, _2359,
    _2362, _2365, _2377, _2385,
    _2388
)
...
class ConnectionModalAnalysis(_6538.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4818.ModalAnalysis':
        ...
        if _4818.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def excited_modes_summary(self) -> 'List[_4889.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4889.SingleExcitationResultsModalAnalysis))
        return value

    @property
    def system_deflection_results(self) -> '_2286.ConnectionSystemDeflection':
        ...
        if _2286.ConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_agma_gleason_conical_gear_mesh_system_deflection(self) -> '_2253.AGMAGleasonConicalGearMeshSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_belt_connection_system_deflection(self) -> '_2258.BeltConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_coaxial_connection_system_deflection(self) -> '_2273.CoaxialConnectionSystemDeflection':
        ...
        if _2273.CoaxialConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_gear_mesh_system_deflection(self) -> '_2279.ConceptGearMeshSystemDeflection':
        ...
        if _2279.ConceptGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_conical_gear_mesh_system_deflection(self) -> '_2283.ConicalGearMeshSystemDeflection':
        ...
        if _2283.ConicalGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_coupling_connection_system_deflection(self) -> '_2288.CouplingConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_cvt_belt_connection_system_deflection(self) -> '_2291.CVTBeltConnectionSystemDeflection':
        ...
        if _2291.CVTBeltConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_mesh_system_deflection(self) -> '_2294.CylindricalGearMeshSystemDeflection':
        ...
        if _2294.CylindricalGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_mesh_system_deflection_timestep(self) -> '_2295.CylindricalGearMeshSystemDeflectionTimestep':
        ...
        if _2295.CylindricalGearMeshSystemDeflectionTimestep.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_mesh_system_deflection_with_ltca_results(self) -> '_2296.CylindricalGearMeshSystemDeflectionWithLTCAResults':
        ...
        if _2296.CylindricalGearMeshSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_face_gear_mesh_system_deflection(self) -> '_2307.FaceGearMeshSystemDeflection':
        ...
        if _2307.FaceGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_gear_mesh_system_deflection(self) -> '_2311.GearMeshSystemDeflection':
        ...
        if _2311.GearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_inter_mountable_component_connection_system_deflection(self) -> '_2319.InterMountableComponentConnectionSystemDeflection':
        ...
        if _2319.InterMountableComponentConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh_system_deflection(self) -> '_2320.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection':
        ...
        if _2320.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh_system_deflection(self) -> '_2323.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
        ...
        if _2323.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_system_deflection(self) -> '_2326.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
        ...
        if _2326.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_planetary_connection_system_deflection(self) -> '_2341.PlanetaryConnectionSystemDeflection':
        ...
        if _2341.PlanetaryConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_rolling_ring_connection_system_deflection(self) -> '_2347.RollingRingConnectionSystemDeflection':
        ...
        if _2347.RollingRingConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_shaft_to_mountable_component_connection_system_deflection(self) -> '_2354.ShaftToMountableComponentConnectionSystemDeflection':
        ...
        if _2354.ShaftToMountableComponentConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_worm_gear_mesh_system_deflection(self) -> '_2385.WormGearMeshSystemDeflection':
        ...
        if _2385.WormGearMeshSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
