...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4784, _4730, _4732, _4735,
    _4742, _4741, _4745, _4750,
    _4753, _4764, _4768, _4774,
    _4775, _4783, _4791, _4794,
    _4795, _4796, _4802, _4807,
    _4810, _4811, _4812, _4818,
    _4814, _4819, _4825, _4828,
    _4831, _4834, _4838, _4842,
    _4845, _4854, _4857, _4724
)
...
class AssemblyModalAnalysis(_4724.AbstractAssemblyModalAnalysis):
    '''AssemblyModalAnalysis
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4784.ImportedFEComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEMeshesForCalculatingModes, constructor.new(_4784.ImportedFEComponentModalAnalysis))
        return value

    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4858.CalculateFullFEResultsForMode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculateFullFEResultsByMode, constructor.new(_4858.CalculateFullFEResultsForMode))
        return value

    @property
    def bearings(self) -> 'List[_4730.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bearings, constructor.new(_4730.BearingModalAnalysis))
        return value

    @property
    def belt_drives(self) -> 'List[_4732.BeltDriveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltDrives, constructor.new(_4732.BeltDriveModalAnalysis))
        return value

    @property
    def bevel_differential_gear_sets(self) -> 'List[_4735.BevelDifferentialGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearSets, constructor.new(_4735.BevelDifferentialGearSetModalAnalysis))
        return value

    @property
    def bolts(self) -> 'List[_4742.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bolts, constructor.new(_4742.BoltModalAnalysis))
        return value

    @property
    def bolted_joints(self) -> 'List[_4741.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltedJoints, constructor.new(_4741.BoltedJointModalAnalysis))
        return value

    @property
    def clutches(self) -> 'List[_4745.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_4745.ClutchModalAnalysis))
        return value

    @property
    def concept_couplings(self) -> 'List[_4750.ConceptCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptCouplings, constructor.new(_4750.ConceptCouplingModalAnalysis))
        return value

    @property
    def concept_gear_sets(self) -> 'List[_4753.ConceptGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearSets, constructor.new(_4753.ConceptGearSetModalAnalysis))
        return value

    @property
    def cv_ts(self) -> 'List[_4764.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CVTs, constructor.new(_4764.CVTModalAnalysis))
        return value
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4775.FlexiblePinAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FlexiblePinAssemblies, constructor.new(_4775.FlexiblePinAssemblyModalAnalysis))
        return value

    @property
    def hypoid_gear_sets(self) -> 'List[_4783.HypoidGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearSets, constructor.new(_4783.HypoidGearSetModalAnalysis))
        return value

    @property
    def imported_fe_components(self) -> 'List[_4784.ImportedFEComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEComponents, constructor.new(_4784.ImportedFEComponentModalAnalysis))
        return value
    ...
    @property
    def oil_seals(self) -> 'List[_4802.OilSealModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OilSeals, constructor.new(_4802.OilSealModalAnalysis))
        return value

    @property
    def part_to_part_shear_couplings(self) -> 'List[_4807.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PartToPartShearCouplings, constructor.new(_4807.PartToPartShearCouplingModalAnalysis))
        return value

    @property
    def planet_carriers(self) -> 'List[_4810.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetCarriers, constructor.new(_4810.PlanetCarrierModalAnalysis))
        return value

    @property
    def point_loads(self) -> 'List[_4811.PointLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointLoads, constructor.new(_4811.PointLoadModalAnalysis))
        return value

    @property
    def power_loads(self) -> 'List[_4812.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PowerLoads, constructor.new(_4812.PowerLoadModalAnalysis))
        return value

    @property
    def shaft_hub_connections(self) -> 'List[_4818.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftHubConnections, constructor.new(_4818.ShaftHubConnectionModalAnalysis))
        return value

    @property
    def rolling_ring_assemblies(self) -> 'List[_4814.RollingRingAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRingAssemblies, constructor.new(_4814.RollingRingAssemblyModalAnalysis))
        return value

    @property
    def shafts(self) -> 'List[_4819.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shafts, constructor.new(_4819.ShaftModalAnalysis))
        return value

    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4825.SpiralBevelGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearSets, constructor.new(_4825.SpiralBevelGearSetModalAnalysis))
        return value

    @property
    def spring_dampers(self) -> 'List[_4828.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDampers, constructor.new(_4828.SpringDamperModalAnalysis))
        return value

    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4831.StraightBevelDiffGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearSets, constructor.new(_4831.StraightBevelDiffGearSetModalAnalysis))
        return value

    @property
    def straight_bevel_gear_sets(self) -> 'List[_4834.StraightBevelGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearSets, constructor.new(_4834.StraightBevelGearSetModalAnalysis))
        return value

    @property
    def synchronisers(self) -> 'List[_4838.SynchroniserModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Synchronisers, constructor.new(_4838.SynchroniserModalAnalysis))
        return value

    @property
    def torque_converters(self) -> 'List[_4842.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueConverters, constructor.new(_4842.TorqueConverterModalAnalysis))
        return value

    @property
    def unbalanced_masses(self) -> 'List[_4845.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.UnbalancedMasses, constructor.new(_4845.UnbalancedMassModalAnalysis))
        return value

    @property
    def worm_gear_sets(self) -> 'List[_4854.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearSets, constructor.new(_4854.WormGearSetModalAnalysis))
        return value

    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4857.ZerolBevelGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearSets, constructor.new(_4857.ZerolBevelGearSetModalAnalysis))
        return value
