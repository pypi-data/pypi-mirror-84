...
from mastapy.utility.modal_analysis import _1319
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2204.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1319.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1319.DesignEntityExcitationDescription))
        return value
