...
class StraightBevelSunGearModalAnalysis(_4851.StraightBevelDiffGearModalAnalysis):
    '''StraightBevelSunGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2369.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2369.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
