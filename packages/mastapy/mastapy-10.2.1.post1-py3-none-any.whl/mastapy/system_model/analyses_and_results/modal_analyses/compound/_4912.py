...
class ClutchHalfCompoundModalAnalysis(_4928.CouplingHalfCompoundModalAnalysis):
    '''ClutchHalfCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4765.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4765.ClutchHalfModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4765.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4765.ClutchHalfModalAnalysis))
        return value
