...
class ImportedFEComponentModalAnalysis(_4746.AbstractShaftOrHousingModalAnalysis):
    '''ImportedFEComponentModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_1525.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_1525.ModalCMSResults))
        return value
