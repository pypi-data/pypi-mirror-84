...
from mastapy.system_model.analyses_and_results.system_deflections import _2297, _2298, _2299
from mastapy.system_model.analyses_and_results.modal_analyses import _4788, _4787, _4800
...
class CylindricalGearSetModalAnalysis(_4800.GearSetModalAnalysis):
    '''CylindricalGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2297.CylindricalGearSetSystemDeflection':
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4788.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysis, constructor.new(_4788.CylindricalGearModalAnalysis))
        return value

    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4787.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysis, constructor.new(_4787.CylindricalGearMeshModalAnalysis))
        return value
