...
class MeasurementComponentModalAnalysis(_4867.VirtualComponentModalAnalysis):
    '''MeasurementComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2332.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2332.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
