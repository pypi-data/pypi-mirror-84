...
class KlingelnbergCycloPalloidHypoidGearModalAnalysis(_4808.KlingelnbergCycloPalloidConicalGearModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2325.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2325.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
