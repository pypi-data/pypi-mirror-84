...
class CVTPulleyModalAnalysis(_4834.PulleyModalAnalysis):
    '''CVTPulleyModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2292.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2292.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
