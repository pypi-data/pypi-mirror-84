...
class SpiralBevelGearModalAnalysis(_4760.BevelGearModalAnalysis):
    '''SpiralBevelGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2358.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2358.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
