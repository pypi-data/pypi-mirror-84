...
class ZerolBevelGearSystemDeflection(_2267.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3385.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3385.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
