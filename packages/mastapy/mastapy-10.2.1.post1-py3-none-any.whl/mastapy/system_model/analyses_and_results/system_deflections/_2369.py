...
class StraightBevelSunGearSystemDeflection(_2364.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3369.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3369.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
