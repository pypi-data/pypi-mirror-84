...
from mastapy.system_model.analyses_and_results.power_flows import _3363, _3368, _3369
...
class StraightBevelDiffGearSystemDeflection(_2267.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3363.StraightBevelDiffGearPowerFlow':
