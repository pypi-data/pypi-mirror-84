...
class MassDiscSystemDeflection(_2384.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3332.MassDiscPowerFlow':
        ...
        return constructor.new(_3332.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
