...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2399
...
class ShaftHubConnectionSystemDeflection(_2287.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3352.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3352.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2399.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2399.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2399.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2399.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2399.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2399.SplineFlankContactReporting))
        return value
