...
class ShaftSectionSystemDeflection(_1447.Bar):
    ...
    @property
    def left_end(self) -> '_2351.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2351.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2351.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2351.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
