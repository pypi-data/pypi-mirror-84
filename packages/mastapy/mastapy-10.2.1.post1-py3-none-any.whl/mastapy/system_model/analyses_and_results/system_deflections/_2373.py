...
from mastapy.system_model.analyses_and_results.system_deflections import _2370, _2355
...
class SynchroniserSystemDeflection(_2355.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3372.SynchroniserPowerFlow':
        ...
        return constructor.new(_3372.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def cones(self) -> 'List[_2370.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2370.SynchroniserHalfSystemDeflection))
        return value
