...
from mastapy.system_model.analyses_and_results.system_deflections import _2367, _2365, _2266
...
class StraightBevelGearSetSystemDeflection(_2266.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3367.StraightBevelGearSetPowerFlow':
        ...
        return constructor.new(_3367.StraightBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2367.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2367.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2365.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2365.StraightBevelGearMeshSystemDeflection))
        return value
