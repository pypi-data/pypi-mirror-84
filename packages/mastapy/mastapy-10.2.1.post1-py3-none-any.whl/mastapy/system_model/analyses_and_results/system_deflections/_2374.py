...
from mastapy.system_model.analyses_and_results.system_deflections import _2329, _2376
...
class SystemDeflection(_6541.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2329.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2329.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2376.SystemDeflectionOptions':
        ...
        return constructor.new(_2376.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
