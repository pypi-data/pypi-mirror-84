...
class RollingRingSystemDeflection(_2289.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3350.RollingRingPowerFlow':
        ...
        return constructor.new(_3350.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
