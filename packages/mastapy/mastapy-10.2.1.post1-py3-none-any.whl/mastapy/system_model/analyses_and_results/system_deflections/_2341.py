...
class PlanetaryConnectionSystemDeflection(_2354.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3340.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3340.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
