...
class SpiralBevelGearSystemDeflection(_2267.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3357.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3357.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
