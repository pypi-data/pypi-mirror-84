...
from mastapy.system_model.part_model import (
    _2062, _2046, _2047, _2055,
    _2056, _2061
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.power_flows import (
    _3380, _3332, _3333, _3343,
    _3346, _3379
)
...
class VirtualComponentSystemDeflection(_2334.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def component_design(self) -> '_2062.VirtualComponent':
    ...
    @property
    def power_flow_results(self) -> '_3380.VirtualComponentPowerFlow':
        ...
        if _3380.VirtualComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_mass_disc_power_flow(self) -> '_3332.MassDiscPowerFlow':
        ...
        if _3332.MassDiscPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_measurement_component_power_flow(self) -> '_3333.MeasurementComponentPowerFlow':
        ...
        if _3333.MeasurementComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_point_load_power_flow(self) -> '_3343.PointLoadPowerFlow':
        ...
        if _3343.PointLoadPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_power_load_power_flow(self) -> '_3346.PowerLoadPowerFlow':
        ...
        if _3346.PowerLoadPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_unbalanced_mass_power_flow(self) -> '_3379.UnbalancedMassPowerFlow':
        ...
        if _3379.UnbalancedMassPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
