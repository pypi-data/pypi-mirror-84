...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4307, _4306, _4312
...
class FaceGearSetModalAnalysisAtAStiffness(_4312.GearSetModalAnalysisAtAStiffness):
    '''FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4307.FaceGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtAStiffness, constructor.new(_4307.FaceGearModalAnalysisAtAStiffness))
        return value

    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4306.FaceGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtAStiffness, constructor.new(_4306.FaceGearMeshModalAnalysisAtAStiffness))
        return value
