...
from mastapy.bearings.bearing_results.rolling import (
    _1677, _1637, _1642, _1645,
    _1653, _1657, _1669, _1672,
    _1688, _1691, _1697, _1706,
    _1623, _1682
)
...
class LoadedRollerBearingRow(_1682.LoadedRollingBearingRow):
    '''LoadedRollerBearingRow
    ...
    @property
    def shear_stress_chart_inner(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ShearStressChartInner) if self.wrapped.ShearStressChartInner else None

    @property
    def shear_stress_chart_outer(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.ShearStressChartOuter) if self.wrapped.ShearStressChartOuter else None

    @property
    def depth_of_maximum_shear_stress_chart_inner(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartInner) if self.wrapped.DepthOfMaximumShearStressChartInner else None

    @property
    def depth_of_maximum_shear_stress_chart_outer(self) -> '_6555.SMTBitmap':
        ...
        return constructor.new(_6555.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartOuter) if self.wrapped.DepthOfMaximumShearStressChartOuter else None

    @property
    def loaded_bearing(self) -> '_1677.LoadedRollerBearingResults':
    ...
    @property
    def lamina_dynamic_equivalent_loads(self) -> 'List[_1623.ForceAtLaminaGroupReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LaminaDynamicEquivalentLoads, constructor.new(_1623.ForceAtLaminaGroupReportable))
        return value
