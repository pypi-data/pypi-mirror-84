...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5078, _5116, _5111
...
class MBDRunUpAnalysisOptions(_6533.AbstractAnalysisOptions['_6248.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5078.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5078.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5078.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5116.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5116.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5116.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5111.RunUpDrivingMode':
        ...
        return constructor.new(_5111.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5111.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
