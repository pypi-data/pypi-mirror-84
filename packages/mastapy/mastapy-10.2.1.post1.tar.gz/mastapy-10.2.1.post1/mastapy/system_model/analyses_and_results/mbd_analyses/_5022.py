...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5106, _5117
...
class BeltDriveMultiBodyDynamicsAnalysis(_5117.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''BeltDriveMultiBodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5106.PulleyMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5106.PulleyMultiBodyDynamicsAnalysis))
        return value
