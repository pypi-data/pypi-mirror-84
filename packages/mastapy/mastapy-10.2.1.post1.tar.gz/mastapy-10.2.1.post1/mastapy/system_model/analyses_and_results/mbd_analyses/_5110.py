...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5095, _5018
...
class RootAssemblyMultiBodyDynamicsAnalysis(_5018.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5095.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5095.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
