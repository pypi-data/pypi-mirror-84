...
class SpringDamperConnectionCompoundMultiBodyDynamicsAnalysis(_5193.CouplingConnectionCompoundMultiBodyDynamicsAnalysis):
    '''SpringDamperConnectionCompoundMultiBodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5121.SpringDamperConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5121.SpringDamperConnectionMultiBodyDynamicsAnalysis))
        return value

    @property
    def connection_multi_body_dynamics_analysis_load_cases(self) -> 'List[_5121.SpringDamperConnectionMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultiBodyDynamicsAnalysisLoadCases, constructor.new(_5121.SpringDamperConnectionMultiBodyDynamicsAnalysis))
        return value
