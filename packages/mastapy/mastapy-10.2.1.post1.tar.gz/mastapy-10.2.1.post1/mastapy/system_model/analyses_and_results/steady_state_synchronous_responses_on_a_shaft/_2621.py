...
class SteadyStateSynchronousResponseOnAShaft(_6547.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3110.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3110.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
