...
class ClutchConnectionCompoundModalAnalysisAtAStiffness(_4417.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    '''ClutchConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_design(self) -> '_1934.ClutchConnection':
        ...
        return constructor.new(_1934.ClutchConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4277.ClutchConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4277.ClutchConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_modal_analysis_at_a_stiffness_load_cases(self) -> 'List[_4277.ClutchConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysisAtAStiffnessLoadCases, constructor.new(_4277.ClutchConnectionModalAnalysisAtAStiffness))
        return value
