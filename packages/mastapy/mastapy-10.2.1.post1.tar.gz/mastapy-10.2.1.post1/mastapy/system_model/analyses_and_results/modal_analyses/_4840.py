...
class ShaftModalAnalysis(_4746.AbstractShaftOrHousingModalAnalysis):
    '''ShaftModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2353.ShaftSystemDeflection':
        ...
        return constructor.new(_2353.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
