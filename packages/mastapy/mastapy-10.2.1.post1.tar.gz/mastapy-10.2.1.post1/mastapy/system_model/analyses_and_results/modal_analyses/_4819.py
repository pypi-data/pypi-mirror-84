...
from mastapy.nodal_analysis import _1380, _1379
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1379.BarModelAnalysisType':
        ...
        return constructor.new(_1379.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1379.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1475.EigenvalueOptions':
        ...
        return constructor.new(_1475.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
