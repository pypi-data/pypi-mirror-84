...
class KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis(_4807.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2323.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2323.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
