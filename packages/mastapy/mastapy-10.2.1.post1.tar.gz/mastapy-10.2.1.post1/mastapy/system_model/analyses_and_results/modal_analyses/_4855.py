...
from mastapy.system_model.analyses_and_results.modal_analyses import _4854, _4853, _4761
...
class StraightBevelGearSetModalAnalysis(_4761.BevelGearSetModalAnalysis):
    '''StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4854.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysis, constructor.new(_4854.StraightBevelGearModalAnalysis))
        return value

    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4853.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysis, constructor.new(_4853.StraightBevelGearMeshModalAnalysis))
        return value
