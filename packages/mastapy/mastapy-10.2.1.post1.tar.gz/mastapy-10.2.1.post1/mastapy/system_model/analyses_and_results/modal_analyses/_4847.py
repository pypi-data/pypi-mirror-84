...
class SpringDamperConnectionModalAnalysis(_4781.CouplingConnectionModalAnalysis):
    '''SpringDamperConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2359.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2359.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
