...
class OilSealCompoundModalAnalysis(_4925.ConnectorCompoundModalAnalysis):
    '''OilSealCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4823.OilSealModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4823.OilSealModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4823.OilSealModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4823.OilSealModalAnalysis))
        return value
