...
class StraightBevelGearMeshModalAnalysis(_4759.BevelGearMeshModalAnalysis):
    '''StraightBevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2365.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
