...
class ConceptGearMeshModalAnalysis(_4798.GearMeshModalAnalysis):
    '''ConceptGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2279.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2279.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
