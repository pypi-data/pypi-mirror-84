...
class ConicalGearMeshModalAnalysis(_4798.GearMeshModalAnalysis):
    '''ConicalGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2283.ConicalGearMeshSystemDeflection':
