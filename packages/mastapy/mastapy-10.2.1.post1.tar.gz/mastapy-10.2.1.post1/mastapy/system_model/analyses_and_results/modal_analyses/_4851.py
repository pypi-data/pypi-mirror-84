...
from mastapy.system_model.analyses_and_results.system_deflections import _2364, _2368, _2369
...
class StraightBevelDiffGearModalAnalysis(_4760.BevelGearModalAnalysis):
    '''StraightBevelDiffGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2364.StraightBevelDiffGearSystemDeflection':
