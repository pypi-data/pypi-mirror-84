...
from mastapy.system_model.analyses_and_results.modal_analyses import _4845, _4844, _4761
...
class SpiralBevelGearSetModalAnalysis(_4761.BevelGearSetModalAnalysis):
    '''SpiralBevelGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2357.SpiralBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2357.SpiralBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4845.SpiralBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysis, constructor.new(_4845.SpiralBevelGearModalAnalysis))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4844.SpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysis, constructor.new(_4844.SpiralBevelGearMeshModalAnalysis))
        return value
