...
class SpiralBevelGearMeshModalAnalysis(_4759.BevelGearMeshModalAnalysis):
    '''SpiralBevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2356.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2356.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
