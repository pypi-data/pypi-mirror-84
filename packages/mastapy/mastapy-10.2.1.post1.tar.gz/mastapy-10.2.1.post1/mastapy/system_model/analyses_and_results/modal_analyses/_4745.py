...
from mastapy.system_model.analyses_and_results.modal_analyses import _4768, _4798, _4825
...
class AbstractAssemblyModalAnalysis(_4825.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4768.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4768.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4798.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4798.GearMeshModalAnalysis))
        return value
