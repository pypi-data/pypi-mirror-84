...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4544, _4543, _4555
...
class CylindricalGearSetModalAnalysisAtASpeed(_4555.GearSetModalAnalysisAtASpeed):
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_4544.CylindricalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtASpeed, constructor.new(_4544.CylindricalGearModalAnalysisAtASpeed))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_4543.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtASpeed, constructor.new(_4543.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
