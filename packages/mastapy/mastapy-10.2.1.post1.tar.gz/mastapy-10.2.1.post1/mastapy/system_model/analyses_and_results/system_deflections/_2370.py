...
from mastapy.system_model.analyses_and_results.system_deflections import _2270, _2371
...
class SynchroniserHalfSystemDeflection(_2371.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2270.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2270.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3370.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3370.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
