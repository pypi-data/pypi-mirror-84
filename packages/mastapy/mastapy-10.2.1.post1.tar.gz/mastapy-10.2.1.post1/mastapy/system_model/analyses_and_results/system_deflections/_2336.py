...
class OilSealSystemDeflection(_2287.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3335.OilSealPowerFlow':
        ...
        return constructor.new(_3335.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
