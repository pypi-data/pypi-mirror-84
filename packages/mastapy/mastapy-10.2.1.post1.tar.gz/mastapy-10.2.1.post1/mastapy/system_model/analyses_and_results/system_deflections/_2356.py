...
class SpiralBevelGearMeshSystemDeflection(_2265.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3356.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3356.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
