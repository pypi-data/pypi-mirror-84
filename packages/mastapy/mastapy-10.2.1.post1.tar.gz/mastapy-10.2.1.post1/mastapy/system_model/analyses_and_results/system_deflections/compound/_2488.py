...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2489, _2401
...
class ShaftCompoundSystemDeflection(_2401.AbstractShaftOrHousingCompoundSystemDeflection):
    '''ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2489.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2489.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2353.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2353.ShaftSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2353.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2353.ShaftSystemDeflection))
        return value
