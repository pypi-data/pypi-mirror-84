...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2446, _2405
...
class RootAssemblyCompoundSystemDeflection(_2405.AssemblyCompoundSystemDeflection):
    '''RootAssemblyCompoundSystemDeflection
    ...
    @property
    def duty_cycle_efficiency_results(self) -> '_2446.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2446.DutyCycleEfficiencyResults)(self.wrapped.DutyCycleEfficiencyResults) if self.wrapped.DutyCycleEfficiencyResults else None

    @property
    def root_assembly_compound_power_flow(self) -> '_3473.RootAssemblyCompoundPowerFlow':
        ...
        return constructor.new(_3473.RootAssemblyCompoundPowerFlow)(self.wrapped.RootAssemblyCompoundPowerFlow) if self.wrapped.RootAssemblyCompoundPowerFlow else None
