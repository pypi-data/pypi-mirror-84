...
from mastapy.system_model.drawing import _1868, _1866
...
class SystemDeflectionDrawStyle(_1866.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1868.ScalingDrawStyle':
        ...
        return constructor.new(_1868.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
