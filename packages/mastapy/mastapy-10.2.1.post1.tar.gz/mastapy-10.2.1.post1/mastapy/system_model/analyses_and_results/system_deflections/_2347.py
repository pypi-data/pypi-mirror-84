...
class RollingRingConnectionSystemDeflection(_2319.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3349.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3349.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
