...
from mastapy.system_model.analyses_and_results.system_deflections import _2358, _2356, _2266
...
class SpiralBevelGearSetSystemDeflection(_2266.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3358.SpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3358.SpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2358.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2358.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2356.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2356.SpiralBevelGearMeshSystemDeflection))
        return value
