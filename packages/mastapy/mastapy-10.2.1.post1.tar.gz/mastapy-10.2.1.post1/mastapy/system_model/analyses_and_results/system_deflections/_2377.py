...
class TorqueConverterConnectionSystemDeflection(_2288.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3375.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3375.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
