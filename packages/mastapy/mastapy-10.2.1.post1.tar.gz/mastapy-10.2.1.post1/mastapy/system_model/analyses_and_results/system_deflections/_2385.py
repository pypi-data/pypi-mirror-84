...
class WormGearMeshSystemDeflection(_2311.GearMeshSystemDeflection):
    '''WormGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3381.WormGearMeshPowerFlow':
        ...
        return constructor.new(_3381.WormGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
