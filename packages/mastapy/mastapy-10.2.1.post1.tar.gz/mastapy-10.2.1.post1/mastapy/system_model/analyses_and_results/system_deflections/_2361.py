...
class SpringDamperSystemDeflection(_2290.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3361.SpringDamperPowerFlow':
        ...
        return constructor.new(_3361.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
