...
class WormGearSystemDeflection(_2313.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3382.WormGearPowerFlow':
        ...
        return constructor.new(_3382.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
