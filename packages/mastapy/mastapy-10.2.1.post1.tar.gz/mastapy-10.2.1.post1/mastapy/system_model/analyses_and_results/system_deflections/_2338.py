...
class PartToPartShearCouplingConnectionSystemDeflection(_2288.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3337.PartToPartShearCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3337.PartToPartShearCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
