...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5293, _5294, _5297
from mastapy.system_model.part_model.gears import _2114, _2112
from mastapy.system_model.analyses_and_results.static_loads import _6168, _6170, _6173
...
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6168.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1914.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6170.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6173.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5297.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5293.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5293.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5294.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5294.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
