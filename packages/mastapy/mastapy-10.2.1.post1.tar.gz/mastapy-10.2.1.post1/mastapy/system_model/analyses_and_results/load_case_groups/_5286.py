...
from mastapy.system_model.analyses_and_results.load_case_groups import _5279
...
class GroupOfTimeSeriesLoadCases(_5279.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6248.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6248.TimeSeriesLoadCase))
        return value
