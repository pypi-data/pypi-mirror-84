...
class MastaSettings:
    ...
    @property
    def electric_machine_detail_database(self) -> '_6152.ElectricMachineDetailDatabase':
        ...
        return constructor.new(_6152.ElectricMachineDetailDatabase)(self.wrapped.ElectricMachineDetailDatabase) if self.wrapped.ElectricMachineDetailDatabase else None
