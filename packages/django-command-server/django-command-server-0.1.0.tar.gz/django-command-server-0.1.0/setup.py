...
setup(
    ...
    packages=find_packages(".", exclude=["django_command_server_example", "django_command_server_example.migrations", "django_command_server_example.management", "django_command_server_example.management.commands", "django_command_server_demo"]),
