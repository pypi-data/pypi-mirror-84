...
class RestrictionMosaicRoutesApi(object):
    ...
    def search_mosaic_restriction(self, **kwargs):  # noqa: E501
        ...
        return self.search_mosaic_restriction_with_http_info(**kwargs)  # noqa: E501

    def search_mosaic_restriction_with_http_info(self, **kwargs):  # noqa: E501
        """Search mosaic restrictions  # noqa: E501

        Returns an array of mosaic restrictions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_mosaic_restriction_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method search_mosaic_restriction" % key
                )
        ...
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `search_mosaic_restriction`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_size' in local_var_params and local_var_params['page_size'] < 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_size` when calling `search_mosaic_restriction`, must be a value greater than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_number' in local_var_params and local_var_params['page_number'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_number` when calling `search_mosaic_restriction`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
