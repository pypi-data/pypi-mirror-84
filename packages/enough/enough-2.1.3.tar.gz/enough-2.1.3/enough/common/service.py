...
class Service(object):
    ...
    def hosts_with_internal_network(self, hosts):
        info = self.ansible.get_variable_hosts('encrypted_device', 'network_internal_only', *hosts)
        return [host for (host, internal_only) in info.items() if internal_only == 'True']
