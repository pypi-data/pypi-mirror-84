'''Engpy is a free and open-source Python library for Engineering computing
    ...
    vector analysis, analysing signals.

    The Engpy consist of mainly 3 Datatypes:
    1. Expr
        The is the core datatype of Engpy. Most other engpy are based on this class
        This class is responsible for any algebraic manipulations.

            1.  Simple Algebra: Addition, Subtraction, Multiplication, Division
                                Substitution of Expressions; subject of formular,
                                clearing brackets and fractions.
        ...
        it's recomended to use format or repr as they faster than str. Only use str when neccessary
    ...
    2. Matrix
        ...
        4. Row and column Tranformation operations
        5. Decomposition: Triangular, Symmetric, hermittian decomposition
        6. Matrix Geometry: eigen values, modal, spectral, nullspace
    ...
    3. Vector
        This datatype hold the keys to vector analysis.
