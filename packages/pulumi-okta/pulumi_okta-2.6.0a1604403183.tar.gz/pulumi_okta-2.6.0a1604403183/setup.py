...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.6.0-alpha.1604403183+520e9edb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.6.0-alpha.1604403183+520e9edb`
                """)
            else:
                raise
