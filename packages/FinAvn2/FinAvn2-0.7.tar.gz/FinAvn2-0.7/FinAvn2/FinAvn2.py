...
class FinForecast:
    ...
    '''
    It can be seen that the Logistic Regression and Linear Discriminant Analyser were both able to gain a 56% hit rate.
     However, the Quadratic Discriminant Analyser was able to improve on both of them to produce a 60% hit rate. 
     For the particular period analysed, this is likely due to the fact that there is some non-linearity in the 
     relationship between the lagged factors and the direction that isn't well-captured in the linear analysis.
    '''