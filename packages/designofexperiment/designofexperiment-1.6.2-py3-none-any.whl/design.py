...
def plackett_burman(dic_factors, runs):
    ...
    Parameters:
        dic_factors: The dictionary of factors to be included in the Plackett-Burman design.

        runs: The number of runs the design will use, if not a multiple of four then the design will use the next
        multiple of four.

    returns:
        df: A dataframe of the runs for the Plackett-Burman resulting from the factors and runs entered.

    Example:
        >>> import design
        >>> Factors = {'Height':[1.6,2],'Width':[0.2,0.4],'Depth':[0.2,0.3],'Temp':[10,20],'Pressure':[100,200]}
        >>> design.plackett_burman(Factors,10)
            Height  Width  Depth  Temp  Pressure
        0      2.0    0.4    0.3    20       200
        1      1.6    0.2    0.2    20       100
        2      2.0    0.2    0.2    10       200
        3      2.0    0.4    0.2    10       100
        4      2.0    0.4    0.3    10       100
        5      1.6    0.4    0.3    20       100
        6      2.0    0.2    0.3    20       200
        7      2.0    0.4    0.2    20       200
        8      1.6    0.4    0.3    10       200
        9      2.0    0.2    0.3    20       100
        10     1.6    0.4    0.2    20       200
        11     1.6    0.2    0.3    10       200
    ...
    if runs % 4 != 0:
        runs = runs + (4 - (runs % 4))
    # file variable holds the hadamard matrices by looking up the URL that corresponds to the run number
