...
- cparallel.c :
Parallel access to a binary ephemeris file using OpenMP with the C interface. 
...
- f2003parallel.c :
Parallel access to a binary ephemeris file using OpenMP with the Fortran 2003 interface. 
