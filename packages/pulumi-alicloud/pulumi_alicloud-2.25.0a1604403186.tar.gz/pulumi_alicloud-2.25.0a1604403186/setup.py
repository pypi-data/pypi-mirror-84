...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.25.0-alpha.1604403186+06f4bb19'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.25.0-alpha.1604403186+06f4bb19`
                """)
            else:
                raise
