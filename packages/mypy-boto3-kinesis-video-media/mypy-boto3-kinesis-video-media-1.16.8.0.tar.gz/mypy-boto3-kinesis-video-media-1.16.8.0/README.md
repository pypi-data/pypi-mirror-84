...
[boto3.KinesisVideoMedia 1.16.8](https://boto3.amazonaws.com/v1/documentation/api/1.16.8/reference/services/kinesis-video-media.html#KinesisVideoMedia) service
compatible with
