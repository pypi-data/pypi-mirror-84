...
[boto3.CostandUsageReportService 1.16.13](https://boto3.amazonaws.com/v1/documentation/api/1.16.13/reference/services/cur.html#CostandUsageReportService) service
compatible with
