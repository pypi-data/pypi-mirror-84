...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i290 in range(_size286):
                        _elem291 = LinesInFilesRequested()
                        _elem291.read(iprot)
                        self.linesInFilesRequested.append(_elem291)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter292 in self.linesInFilesRequested:
                iter292.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter307, viter308 in self.success.items():
                ...
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter308))
...
class getSeverityCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i343 in range(_size339):
                        _key344 = iprot.readI32()
                        _val345 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter346, viter347 in self.success.items():
                oprot.writeI32(kiter346)
                oprot.writeI64(viter347)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getReviewStatusCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter378, viter379 in self.success.items():
...
class getDetectionStatusCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.I32, TType.I64, len(self.success))
            for kiter394, viter395 in self.success.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i407 in range(_size403):
                        _key408 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val409 = iprot.readI64()
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i460 in range(_size456):
                        _elem461 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.sourceComponentFilter.append(_elem461)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter462 in self.sourceComponentFilter:
                oprot.writeString(iter462.encode('utf-8') if sys.version_info[0] == 2 else iter462)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i474 in range(_size470):
                        ...
                        self.fileHashes.append(_elem475)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter476 in self.fileHashes:
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i488 in range(_size484):
                        ...
                        self.trimPathPrefixes.append(_elem489)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter490 in self.trimPathPrefixes:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i504 in range(_size500):
                        _key505 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val506 = AnalyzerStatistics()
                        _val506.read(iprot)
                        self.success[_key505] = _val506
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
