...
class SIFTS(PDB):
    ...
    @staticmethod
    def select_mo(sele_df, OC_cutoff=0.2):
    ...
    async def pipe_select_ho_base(self, exclude_pdbs=frozenset(), run_as_completed: bool=False, progress_bar=None, **kwargs):
        ...
        p_df['i_group'] = p_df.apply(lambda x: (x['UniProt_1'], x['UniProt_2']), axis=1)
        return p_df

    @staticmethod
    def select_ho(p_df, interface_mapped_cov_cutoff=0.8, unp_range_DSC_cutoff=0.8, wasserstein_distance_cutoff=0.2):
    ...
    @staticmethod
    def select_ho_iso(p_df, interface_mapped_cov_cutoff=0.8, DSC_cutoff=0.2):
        p_df['i_select_tag'] = False
        p_df['i_select_rank'] = -1
    ...
    @staticmethod
    def select_he(p_df, interface_mapped_cov_cutoff=0.8, DSC_cutoff=0.2):
        p_df['i_select_tag'] = False
        p_df['i_select_rank'] = -1
