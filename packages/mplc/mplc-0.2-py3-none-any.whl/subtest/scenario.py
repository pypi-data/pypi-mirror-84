...
class Scenario:
    def __init__(self,
        ...
        params_known += ["methods", "multi_partner_learning_approach",
                         "aggregation"]  # federated learning related
        ...
        if aggregation_weighting in ['uniform', 'data_volume']:
            ...
            raise ValueError(f"aggregation approach'{self.aggregation_weighting}' is not a valid approach. ")
    ...
    def to_dataframe(self):
        ...
        dict_results["aggregation"] = self.aggregation_weighting
