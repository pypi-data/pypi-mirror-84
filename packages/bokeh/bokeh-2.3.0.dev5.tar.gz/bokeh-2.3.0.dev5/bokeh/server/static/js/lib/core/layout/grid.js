...
export class Grid extends Layoutable {
    ...
    _init() {
        ...
        for (let y = 0; y < nrows; y++) {
            const row = (() => {
                var _a;
                const sizing = isPlainObject(this.rows) ? (_a = this.rows[y]) !== null && _a !== void 0 ? _a : this.rows["*"] : this.rows;
                if (sizing == null)
                    return { policy: "auto" };
        ...
        for (let x = 0; x < ncols; x++) {
            const col = (() => {
                var _a;
                const sizing = isPlainObject(this.cols) ? (_a = this.cols[x]) !== null && _a !== void 0 ? _a : this.cols["*"] : this.cols;
                if (sizing == null)
                    return { policy: "auto" };
                else if (isNumber(sizing))
