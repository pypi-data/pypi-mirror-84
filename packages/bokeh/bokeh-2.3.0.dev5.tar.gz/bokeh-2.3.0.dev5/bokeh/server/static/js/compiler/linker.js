...
class Linker {
    ...
    async link() {
        ...
        const print = (module) => {
            var _a;
            let ast = (_a = module.ast) !== null && _a !== void 0 ? _a : this.parse_module(module);
    ...
    store_cache() {
        ...
        for (const artifact of this.cache.values()) {
            const module = Object.assign(Object.assign({}, artifact.module), { changed: undefined, ast: undefined, dependencies: undefined });
            artifacts.push({
    ...
    resolve_relative(dep, parent) {
        ...
        const has_file = has_js_file !== null && has_js_file !== void 0 ? has_js_file : has_json_file;
        if (sys_1.directory_exists(path)) {
...
async function minify(module, source, ecma) {
    ...
    try {
        ...
        return {
            min_source: code !== null && code !== void 0 ? code : "",
