...
class SourcePolymorphic(object):
    ...
    def __init__(self, type=None, path=None, local_vars_configuration=None):  # noqa: E501
        """SourcePolymorphic - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this SourcePolymorphic.  # noqa: E501


        :return: The type of this SourcePolymorphic.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SourcePolymorphic.


        :param type: The type of this SourcePolymorphic.  # noqa: E501
        :type type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["ElifeSource", "GithubSource", "GoogleDocsSource", "GoogleDriveSource", "PlosSource", "UploadSource", "UrlSource"]  # noqa: E501
    ...
    @property
    def path(self):
        """Gets the path of this SourcePolymorphic.  # noqa: E501


        :return: The path of this SourcePolymorphic.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this SourcePolymorphic.


        :param path: The path of this SourcePolymorphic.  # noqa: E501
        :type path: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SourcePolymorphic):
            return False
