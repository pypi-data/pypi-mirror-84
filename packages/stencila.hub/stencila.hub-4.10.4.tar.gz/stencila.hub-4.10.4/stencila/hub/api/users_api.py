...
class UsersApi(object):
    ...
    def users_read(self, user, **kwargs):  # noqa: E501
        ...
        :param user: Username or integer id (required)
        :type user: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.users_read_with_http_info(user, **kwargs)  # noqa: E501

    def users_read_with_http_info(self, user, **kwargs):  # noqa: E501
        """Retrieve a user.  # noqa: E501
        ...
        >>> thread = api.users_read_with_http_info(user, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('user' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `user` when calling `users_read`")  # noqa: E501
