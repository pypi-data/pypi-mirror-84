...
<FStringEvaluatorOpenPopup@FlowPopup>:
    BoxLayout:
        ...
        FlowInput:
            ...
            focus: True
            auto_complete_texts: file_lines("{ado}/FStringEvalSuggestions.txt".format(**PATH_PLACEHOLDERS))
            on_auto_complete_texts:
                file_write(self.auto_complete_texts, "{ado}/FStringEvalSuggestions.txt".format(**PATH_PLACEHOLDERS))
            on_text_validate:
