...
class V1Service(object):
    ...
    def __init__(self, kind=None, environment=None, connections=None, volumes=None, init=None, sidecars=None, container=None, ports=None, rewrite_path=None, local_vars_configuration=None):  # noqa: E501
