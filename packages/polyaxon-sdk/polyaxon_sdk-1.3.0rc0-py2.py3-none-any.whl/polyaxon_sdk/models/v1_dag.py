...
class V1Dag(object):
    ...
    def __init__(self, kind=None, operations=None, components=None, concurrency=None, early_stopping=None, environment=None, connections=None, volumes=None, local_vars_configuration=None):  # noqa: E501
