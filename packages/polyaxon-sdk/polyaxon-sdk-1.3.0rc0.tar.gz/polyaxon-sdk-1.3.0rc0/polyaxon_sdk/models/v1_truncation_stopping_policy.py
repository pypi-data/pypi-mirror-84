...
class V1TruncationStoppingPolicy(object):
    ...
    def __init__(self, kind=None, percent=None, evaluation_interval=None, min_interval=None, min_samples=None, include_succeeded=None, local_vars_configuration=None):  # noqa: E501
