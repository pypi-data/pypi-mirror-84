...
class MainParams(omnicore.core.CoreMainParams):
...
class TestNetParams(omnicore.core.CoreTestNetParams):
...
class RegTestParams(omnicore.core.CoreRegTestParams):
...
omnicore.core.params correctly too.
"""
# params = omnicore.core.coreparams = MainParams()
params = MainParams()
...
def SelectParams(name):
    ...
    """
    global params
    omnicore.core._SelectCoreParams(name)
    if name == "mainnet":
        params = omnicore.core.coreparams = MainParams()
    elif name == "testnet":
        params = omnicore.core.coreparams = TestNetParams()
    elif name == "regtest":
        params = omnicore.core.coreparams = RegTestParams()
    else:
