...
from omnicore.core.script import CScript, OP_0, OP_1, OP_16
from omnicore.bech32 import *
from omnicore.segwit_addr import encode, decode
...
class Test_CBech32Data(unittest.TestCase):
    def test_from_data(self):
        b = CBech32Data.from_bytes(
            0, unhexlify("751e76e8199196d454941c45d1b3a323f1433bd6")
        )
