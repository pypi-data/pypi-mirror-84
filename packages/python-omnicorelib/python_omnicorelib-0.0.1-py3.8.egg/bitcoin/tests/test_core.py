...
class Test_Money(unittest.TestCase):
    ...
    def test_MoneyRangeCustomParams(self):
        highMaxParamsType = type(
            str("CoreHighMainParams"),
            (CoreMainParams, object),
...
class Test_CBlock(unittest.TestCase):
    def test_serialization(self):
        ...
        serialized = genesis.serialize()
        self.assertEqual(
            Hash(serialized[0:80]),
            lx("000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"),
        )
        self.assertEqual(serialized, initial_serialized)

    def test_GetHash(self):
        genesis = CBlock.deserialize(
            x(
                ""
            )
        )
    ...
    def test_calc_merkle_root(self):
        ...
        self.assertEqual(
            block.calc_merkle_root(),
            lx("7dac2c5666815c17a3b36427de37bb9d2e2c5ccec3f8633eb91a4205cb4c10ff"),
        )
        ...
        self.assertEqual(
            block.calc_merkle_root(),
            lx("34d5a57822efa653019edfee29b9586a0d0d807572275b45f39a7e9c25614bf9"),
        )
        ...
        self.assertEqual(
            block.calc_merkle_root(),
            lx("ff2ecc061ab7f9034ba9cbda612b36313b946b1b2696cc09e70f9e9acb791170"),
        )
