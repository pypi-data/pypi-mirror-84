from pm4pyserialization.objects.log.deserialization.variants import parquet_dataframe, pyarrow_event_log, \
    pyarrow_event_stream
...
VERSIONS_APPLY = {PYARROW_EVENT_STREAM: pyarrow_event_stream.apply, PYARROW_EVENT_LOG: pyarrow_event_log.apply,
                  PARQUET_DATAFRAME: parquet_dataframe.apply}

VERSIONS_IMPORT_FILE = {PYARROW_EVENT_STREAM: pyarrow_event_stream.import_from_file,
                        PYARROW_EVENT_LOG: pyarrow_event_log.import_from_file,
                        PARQUET_DATAFRAME: parquet_dataframe.import_from_file}
