...
try:
    from pm4pyserialization.objects.log.importer.parquet.variants import fastparquet
...
try:
    from pm4pyserialization.objects.log.importer.parquet.variants import pyarrow
