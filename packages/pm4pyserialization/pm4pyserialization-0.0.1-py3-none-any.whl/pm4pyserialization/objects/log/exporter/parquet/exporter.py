...
from pm4pyserialization.objects.log.exporter.parquet.variants import pandas as pandas_exporter
...
try:
    from pm4pyserialization.objects.log.exporter.parquet.variants import pyarrow
