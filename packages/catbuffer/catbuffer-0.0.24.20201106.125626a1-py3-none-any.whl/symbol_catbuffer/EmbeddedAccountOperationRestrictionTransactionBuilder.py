...
class EmbeddedAccountOperationRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def __init__(self, size: int, signerPublicKey: KeyDto, version: int, network: NetworkTypeDto, type: EntityTypeDto, restrictionFlags: List[AccountRestrictionFlagsDto], restrictionAdditions: List[EntityTypeDto], restrictionDeletions: List[EntityTypeDto]):
        """Constructor.
        Args:
            size: Entity size.
