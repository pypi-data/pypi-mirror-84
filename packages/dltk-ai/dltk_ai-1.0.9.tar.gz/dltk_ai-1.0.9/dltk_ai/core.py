...
class DltkAiClient:
    ...
    def visual_search(self, image_path_1, image_path_2):
        """
        ...
        """
        body = {'image_1': (image_path_1, open(image_path_1, 'rb'), 'multipart/form-data'), 'image_2': (image_path_2, open(image_path_2, 'rb'), 'multipart/form/data')}
