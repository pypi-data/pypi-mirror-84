...
class HelicsFilter(_HelicsCHandle):
    ...
    def add_destination_target(self, dest     ):
        """
    ...
    def remove_destination_target(self, dest     ):
...
class HelicsEndpoint(_HelicsCHandle):
    ...
    def default_destination(self, dest     ):
...
def helicsEndpointSendTo(endpoint                , dst     , data       ):
    """
