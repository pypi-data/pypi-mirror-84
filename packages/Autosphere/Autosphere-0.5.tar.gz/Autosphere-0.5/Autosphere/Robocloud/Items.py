...
from Autosphere.FileSystem import FileSystem
from Autosphere.core.helpers import import_by_name, required_env
from Autosphere.core.notebook import notebook_print
...
class FileAdapter(BaseAdapter):
    ...
    * AutoSphere_WORKITEMS_PATH:   Path to work items database file
    """

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.path = required_env("AutoSphere_WORKITEMS_PATH")
...
class Items:
    """A library for interacting with Autosphere work items.
    ...
    * RC_WORKITEM_ID:        Current default work item ID
    ...
    def _load_adapter(self, default):
        ...
        adapter = required_env("AutoSphere_WORKITEMS_ADAPTER", default)
