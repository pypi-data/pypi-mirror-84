...
class App(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdkactions.App"):
    ...
    def __init__(self, *, create_validate_workflow: builtins.bool) -> None:
        ...
        """
        options = AppOptions(create_validate_workflow=create_validate_workflow)
...
@jsii.data_type(
    jsii_type="cdkactions.AppOptions",
    jsii_struct_bases=[],
    name_mapping={"create_validate_workflow": "createValidateWorkflow"},
)
class AppOptions:
    def __init__(self, *, create_validate_workflow: builtins.bool) -> None:
    ...
    @builtins.property
    def create_validate_workflow(self) -> builtins.bool:
        ...
        assert result is not None, "Required property 'create_validate_workflow' is missing"
        return result
...
@jsii.data_type(
    jsii_type="cdkactions.CredentialsConfig",
    jsii_struct_bases=[],
...
class CredentialsConfig:
    ...
    def __repr__(self) -> str:
        return "CredentialsConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="cdkactions.DefaultsRunConfig",
    jsii_struct_bases=[],
    name_mapping={"run": "run"},
)
class DefaultsRunConfig:
    def __init__(self, *, run: typing.Optional["RunConfig"] = None) -> None:
        """
        :param run: 
        """
    ...
    @builtins.property
    def run(self) -> typing.Optional["RunConfig"]:
    ...
    def __repr__(self) -> str:
        return "DefaultsRunConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="cdkactions.DockerConfig",
    jsii_struct_bases=[],
    name_mapping={
        "image": "image",
...
class DockerConfig:
    def __init__(
        ...
        *,
        image: builtins.str,
        credentials: typing.Optional[CredentialsConfig] = None,
    ...
    @builtins.property
    def credentials(self) -> typing.Optional[CredentialsConfig]:
...
class Job(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdkactions.Job"):
    ...
    def __init__(
        ...
        *,
        ...
        steps: typing.List["StepsConfig"],
        container: typing.Optional[DockerConfig] = None,
        continue_on_error: typing.Optional[builtins.bool] = None,
        defaults: typing.Optional[DefaultsRunConfig] = None,
        env: typing.Optional["StringMap"] = None,
        ...
        services: typing.Optional[typing.Mapping[builtins.str, DockerConfig]] = None,
        strategy: typing.Optional["StrategyConfig"] = None,
...
@jsii.data_type(
    jsii_type="cdkactions.JobConfig",
    jsii_struct_bases=[],
    name_mapping={
        "runs_on": "runsOn",
        "steps": "steps",
...
class JobConfig:
    def __init__(
        ...
        *,
        ...
        if isinstance(container, dict):
            container = DockerConfig(**container)
        if isinstance(defaults, dict):
            defaults = DefaultsRunConfig(**defaults)
        if isinstance(env, dict):
            env = StringMap(**env)
    ...
    @builtins.property
    def steps(self) -> typing.List["StepsConfig"]:
    ...
    @builtins.property
    def container(self) -> typing.Optional[DockerConfig]:
    ...
    @builtins.property
    def defaults(self) -> typing.Optional[DefaultsRunConfig]:
    ...
    @builtins.property
    def services(self) -> typing.Optional[typing.Mapping[builtins.str, DockerConfig]]:
        """Additional Docker services provided to the job."""
        result = self._values.get("services")
        return result

    @builtins.property
    def strategy(self) -> typing.Optional["StrategyConfig"]:
...
@jsii.data_type(
    jsii_type="cdkactions.RunConfig",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdkactions.StepsConfig",
    jsii_struct_bases=[RunConfig],
    name_mapping={
        "shell": "shell",
...
class StepsConfig(RunConfig):
    def __init__(
        ...
        *,
        ...
        """Configuration for a single GitHub Action step.
    ...
    def __repr__(self) -> str:
        return "StepsConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="cdkactions.StrategyConfig",
    jsii_struct_bases=[],
    name_mapping={
        "fast_fail": "fastFail",
        "matrix": "matrix",
...
class Workflow(
    ...
    def __init__(
        ...
        *,
        ...
        :param env: A map of environment variables to provide to the job.
        """
        config = WorkflowConfig(name=name, on=on, defaults=defaults, env=env)
...
@jsii.data_type(
    jsii_type="cdkactions.WorkflowConfig",
    jsii_struct_bases=[],
...
class CDKActionsStack(
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        :param id: -
        """
        jsii.create(CDKActionsStack, self, [scope, id])
