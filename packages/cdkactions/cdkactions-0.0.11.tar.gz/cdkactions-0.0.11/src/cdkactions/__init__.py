...
@jsii.data_type(
    jsii_type="cdkactions.CDKActionsConfig",
    jsii_struct_bases=[],
    name_mapping={"push_updated_manifests": "pushUpdatedManifests"},
)
class CDKActionsConfig:
    def __init__(
        self,
        *,
        push_updated_manifests: typing.Optional[builtins.bool] = None,
    ...
    def __repr__(self) -> str:
        return "CDKActionsConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    jsii_type="cdkactions.DefaultsConfig",
    jsii_struct_bases=[],
...
class Job(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdkactions.Job"):
    ...
    def __init__(
        ...
        *,
        ...
        defaults: typing.Optional[DefaultsConfig] = None,
        env: typing.Optional["StringMap"] = None,
...
class JobConfig:
    ...
    @builtins.property
    def defaults(self) -> typing.Optional[DefaultsConfig]:
...
class CDKActionsStack(
    ...
    def __init__(
        ...
        *,
        ...
        :param push_updated_manifests: Push updated manifests if they are out of date. Default: - false
        """
        config = CDKActionsConfig(push_updated_manifests=push_updated_manifests)
