...
from savvihub.common.constants import API_HOST, DEFAULT_SAVVI_DIR, DEFAULT_CONFIG_PATH, WEB_HOST
...
def init(
    ...
    """
    if token is None:
        typer.echo(f'To continue, you must log in. Please continue in below URL.\n{WEB_HOST}/cli-signin?g={token}')
