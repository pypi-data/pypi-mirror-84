...
def get_fonts_statistics(texlines):
    sizes = [span.font['size'] for line in texlines for span in line.spans]
    font_names = [span.font['name'] for line in texlines for span in line.spans]
    colors = [span.font['color'] for line in texlines for span in line.spans]
