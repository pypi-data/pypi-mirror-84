...
from pdf2txt.core import TextEdges, Table
from pdf2txt.utils import text_in_bbox, get_table_index, compute_accuracy, compute_whitespace
...
class Stream():
    ...
    def _generate_table_bbox(self):
        ...
        if self.table_areas is None:
            ...
            for area in self.table_areas:
                table_bbox[(area.x0, area.y0, area.x1, area.y1)] = None
    ...
    def extract_tables(self, table_areas, table_regions=None,  columns=None):
