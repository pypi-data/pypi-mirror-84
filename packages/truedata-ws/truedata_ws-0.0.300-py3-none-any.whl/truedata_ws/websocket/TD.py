...
class TD:
    def __init__(self, login_id, password, broker_token=None, url='push.truedata.in', live_port=8082, historical_port=8092, logger_propagate=False, tz='Asia/Kolkata', logger_level=20):
    ...
    def connect_thread(self):  # TODO: Try catching a disconnection here
