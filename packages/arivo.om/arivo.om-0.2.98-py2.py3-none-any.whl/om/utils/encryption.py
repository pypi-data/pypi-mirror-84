...
class Encryption:
    ...
    def __init__(self):
        ...
        self.init_keys()
        print(self.fingerprints_by_key_name)
    ...
    def remove_old_key(self, fp, key_name):
        if fp in self.old_fingerprints and not self.used_fingerprints[fp]:
            ...
            if key_name and self.fingerprints_by_key_name.get(key_name) == fp:
    ...
    def get_fingerprint(self, key_name="default"):
        ...
        with self.lock:
            ...
            elif self.fingerprints_by_key_name.get(key_name):
...
if __name__ == "__main__":
    while True:
        res = encrypt_file("/data/small")
        print("Encrypted" if res else "Could not encrypt")
        input("Wait for key")
