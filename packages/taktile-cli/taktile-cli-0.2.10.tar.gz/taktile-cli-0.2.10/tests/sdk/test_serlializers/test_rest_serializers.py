...
from tktl.core.serializers.rest import DataFrameSerializer, SeriesSerializer, PassThroughSerializer
...
def test_custom_serializer():
    ...
    as_pydantic_model = PassThroughSerializer.serialize(value=model, output_model=Response)
