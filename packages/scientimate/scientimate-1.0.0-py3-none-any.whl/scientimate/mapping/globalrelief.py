def globalrelief(xmin=-180, xmax=180, ymin=-90, ymax=90, dispout='no'):
    """
    .. ++++++++++++++++++++++++++++++++YA LATIF++++++++++++++++++++++++++++++++++
    .. +                                                                        +
    .. + ScientiMate                                                            +
    ...
    * https://en.wikipedia.org/wiki/Global_relief_model
    ...
    if dispout=='yes':
        ...
        plt.pcolormesh(xgrid,ygrid,zgrid,cmap=cmap_z_mpl,vmin=z_lim_min,vmax=z_lim_max)
    ...
    #--------------------------------------------------------------------------
    #Outputs
    return x, y, z, xgrid, ygrid, zgrid
