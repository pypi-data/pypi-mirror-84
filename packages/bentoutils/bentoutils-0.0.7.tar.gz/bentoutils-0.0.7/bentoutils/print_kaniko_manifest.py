...
def gen_manifest(name, pod_name, version, saved_path):
    manifest = {
        'apiVersion': 'v1',
        'kind': 'Pod',
        'metadata': {
            ...
            'containers': [
                {
                    ...
                    'args': [
                        ...
                        '--destination=gcr.io/apt-phenomenon-243802/{}:{}'.format(pod_name, version),
                        '--snapshotMode=redo',
                    ],
                    'volumeMounts': [
                        {
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 3:
        ...
        print(gen_manifest(name, pod_name, version, saved_path))
    else:
        print(pod_name)
