...
class SimpleRocks(object):
    ...
    def __init__(
        ...
        # TODO: should just create an interface for encode/decode
    ...
    def items(self):
        ...
        for byteskey, bytesvalue in it:
            key, value = self.key_decode(byteskey), self.val_decode(bytesvalue)
            yield key, value
    ...
    def close(self):
        # See this discussion for why we do it this way:
