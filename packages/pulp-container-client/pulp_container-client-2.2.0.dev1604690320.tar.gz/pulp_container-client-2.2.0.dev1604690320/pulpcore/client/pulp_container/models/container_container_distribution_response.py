...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, name=None, base_path=None, content_guard=None, repository_version=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
