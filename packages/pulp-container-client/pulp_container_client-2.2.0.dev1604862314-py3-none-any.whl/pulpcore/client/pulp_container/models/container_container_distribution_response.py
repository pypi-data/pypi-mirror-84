...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, repository=None, pulp_created=None, name=None, base_path=None, content_guard=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
