...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_href=None, pulp_created=None, repository=None, content_guard=None, name=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
