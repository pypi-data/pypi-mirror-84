...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, repository_version=None, name=None, repository=None, pulp_href=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
