...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, repository_version=None, pulp_href=None, base_path=None, repository=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
