...
<<<<<<< Updated upstream
    ...
    def fill_placeholders_at_t0(self, phase, stage, expr, *args):
        if phase==1: return
=======
    def fill_placeholders_t0(self, stage, expr, phase, *args):
        return stage._t0

    def fill_placeholders_T(self, stage, expr, phase, *args):
        return stage._T

    def transcribe_placeholders(self, stage, phase, placeholders):
        """
        Transcription is the process of going from a continuous-time OCP to an NLP
        """
        return stage._transcribe_placeholders(self, phase, placeholders)
 
    def fill_placeholders_integral_control(self, stage, expr, phase, *args):
        return expr

    def fill_placeholders_at_t0(self, stage, expr, phase, *args):
>>>>>>> Stashed changes
        return expr
    ...
    def set_matrices(self):
        ...
        for k, (_,is_vec) in self.m.items():
            ...
            print("DEBUG", k,v)
            if k=="x0":
                self.ocp_solver.constraints_set(0, "lbx", v)
                self.ocp_solver.constraints_set(0, "ubx", v)
            else:
