...
class RenoWebData:
    ...
    async def test_function(self) -> None:
        """Returns a dummy dataset, to test HA updaing is working."""
        items = {}
        item = {
            "Dagrenovation": {
                "description": "description",
                "nextpickupdatetext": "nextpickupdatetext",
                "nextpickupdatetimestamp": "nextpickupdatetimestamp",
                "updatetime": datetime.datetime.now(),
                "nextpickupdate": datetime.datetime.now().isoformat(),
                "schedule": "schedule",
