    ...
    def __init__(self, db_setting):
        ...
        if db_type == EnumDataBase.PG:
            ...
            self._check_db_setting(setting=db_setting,
                                   check_fields=['db_name', 'name', 'host', 'port', 'schema', 'user',
                                                 'password'])
            ...
            self._check_db_setting(setting=db_setting,
                                   check_fields=['db_name', 'name', 'host', 'port', 'user',
                                                 'password'])
            db = MySQLDatabase(
                db_setting['db_name'],
                user=db_setting['user'],
            ...
            self.impala_client = ImpalaClient(db_setting['host'], db_setting['port'])
        else:
