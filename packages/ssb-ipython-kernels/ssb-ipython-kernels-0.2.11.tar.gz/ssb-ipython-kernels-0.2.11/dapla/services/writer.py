from .clients import DataAccessClient, DataAccessError, MetadataPublisherClient, CatalogClient, DatasetDocClient
...
class DataSourceWriter:
    ...
    def __init__(
        ...
        self._dataset_doc_client = DatasetDocClient(user_token_provider, _dataset_doc_client_url)
