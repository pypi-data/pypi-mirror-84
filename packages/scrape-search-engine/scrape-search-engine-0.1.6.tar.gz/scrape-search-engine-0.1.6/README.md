...
## Google Search Engine : 
```
from SearchEngine.SearchEngine import Google
...
## Duckduckgo Search Engine : 
```
from SearchEngine.SearchEngine import Duckduckgo
...
## Givewater Search Engine : 
```
from SearchEngine.SearchEngine import Givewater
...
## Ecosia Search Engine : 
```
from SearchEngine.SearchEngine import Ecosia
...
## Bing Search Engine : 
```
from SearchEngine.SearchEngine import Bing
...
## Yahoo Search Engine : 
```
from SearchEngine.SearchEngine import Yahoo
