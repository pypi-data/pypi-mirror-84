...
def test_jwtpayload():
    ...
    valid = JWTPayload(sub='foo', org='foo', role='foo', foo='bar')
...
def test_init_app(mock_app):
    ...
    mock_app.config.get.assert_called_with('AUTH_SECRET')
