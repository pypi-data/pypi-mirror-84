...
df=predict_stock_trend_by_option('NKE',lastndays=30,power=5)

splt=stock_split('ADS.DE','2020-1-1','2020-11-3')
df=predict_stock_trend_by_option('ADS.DE',lastndays=30,power=5)

splt=stock_split('JD','2020-1-1','2020-11-3')
df=predict_stock_trend_by_option('JD',7)

splt=stock_split('BABA','2020-1-1','2020-11-3')
df=predict_stock_trend_by_option('BABA',lastndays=30,power=6)
