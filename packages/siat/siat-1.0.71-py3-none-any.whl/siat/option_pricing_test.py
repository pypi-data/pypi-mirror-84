...
df=predict_stock_price_by_option('AAPL')

df=predict_stock_price_by_option('02020.HK',lastndays=7)
df=predict_stock_price_by_option('2331.HK',lastndays=7)
df=predict_stock_price_by_option('1368.HK',lastndays=7)
...
df=predict_stock_price_by_option('JD',7)
