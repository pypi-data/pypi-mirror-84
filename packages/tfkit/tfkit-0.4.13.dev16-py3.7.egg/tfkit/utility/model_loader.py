...
def load_trained_model(model_path, pretrained_path=None, model_type=None, model_dataset=None):
    """loading saved model"""
    ...
    eval_dataset = model_class.get_data_from_file(model_dataset)
    ...
    if model_dataset:
        return model, eval_dataset, type
    else:
        return model, type
