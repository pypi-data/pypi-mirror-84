...
class Logger:
    ...
    def write_log(self, *args):
        ...
        with open(os.path.join(self.savedir, self.logfilename), "a", encoding='utf8') as log_file:
            log_file.write(line + '\n')
        print(line)
    ...
    def write_metric(self, *args):
        if self.tensorboard_writer:
            ...
            with open(os.path.join(self.savedir, self.metricfilename), "a", encoding='utf8') as log_file:
