...
class TNSAgent(API):
    ...
    def submit(self, payload: dict = None, debug: bool = True):
        ...
        class Report:
            ...
            reporter = attribute(
                default="CHIME/FRB Collaboration",
                validator=instance_of(str),
            )
            ...
            end_prop_period = attribute(
                default=default_end_prop_period_str,
                validator=instance_of(str),
            )
            ...
            public_webpage = attribute(
                default="https://www.chime-frb.ca",
                validator=instance_of(str),
            )
            region_ellipse = attribute(
                default="",
                validator=instance_of(str),
            )
            ...
            region_polygon = attribute(
                default="",
                validator=instance_of(str),
            )
            region_filename = attribute(
                default="",
                validator=instance_of(str),
            )
            dm = attribute(
            ...
            burst_width = attribute(
                default="",
                validator=instance_of(str),
            )
            burst_width_err = attribute(
                default="",
                validator=instance_of(str),
            )
            ...
            frac_lin_pol = attribute(
                default="",
                validator=instance_of(str),
            )
            frac_lin_pol_err = attribute(
                default="",
                validator=instance_of(str),
            )
            frac_circ_pol = attribute(
                default="",
                validator=instance_of(str),
            )
        ...
        report = Report(**payload.get("frb_report"))
