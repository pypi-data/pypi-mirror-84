...
class PlaceholderEntry(ttk.Entry):
    ...
    BUG 2: Possibility for Anomalous behaviour with config or configure method
    '''
...
class ToolTip():
    ...
    def __init__(self, widget, text, triggerkey='<Enter>', releasekey='<Leave>', bg='#ffffe0', fg='black', side='Right', fadeout='enabled',fadesec=0.10):
