...
def create_all_metadata(
    ...
    include_derived_columns (boolean):
        If True, adds four columns: mojap_latest_record, mojap_start_datetime,
        mojap_end_datetime, mojap_deleted_record.
...
def get_table_meta(
    ...
    derived_columns = [
        ...
        {
            "name": "mojap_deleted_record",
            "type": "boolean",
            "description": "If the record has been deleted",
            "nullable": False,
        },
    ]
