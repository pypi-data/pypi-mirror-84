...
class Account(StreamModel):
    def __init__(self, **kwargs):
        ...
        self.track_county_office_id = kwargs.get('track_county_office_id', self.VALUE_NOT_SET)
        self.is_in_house = kwargs.get('is_in_house', self.VALUE_NOT_SET)
...
class FieldRepApplication(StreamModel):
    def __init__(self, **kwargs):
        ...
        self.documents: List[Document] = [Document(**document) for document in kwargs.get('documents')] if kwargs.get('documents') not in (None, self.VALUE_NOT_SET) else self.VALUE_NOT_SET
        self.created_at = kwargs.get('created_at', self.VALUE_NOT_SET)
        self.updated_at = kwargs.get('updated_at', self.VALUE_NOT_SET)
...
class Document(StreamModel):
    def __init__(self, **kwargs):
        self.event_id = kwargs.get('event_id', self.VALUE_NOT_SET)
        self.uuid = kwargs.get('uuid', self.VALUE_NOT_SET)
        self.name = kwargs.get('name', self.VALUE_NOT_SET)
        self.mime_type = kwargs.get('mime_type', self.VALUE_NOT_SET)
        self.doc_type = kwargs.get('doc_type', self.VALUE_NOT_SET)
        self.doc_requirement = kwargs.get('doc_requirement', self.VALUE_NOT_SET)
        self.path = kwargs.get('path', self.VALUE_NOT_SET)
        self.field_record_id = kwargs.get('field_record_id', self.VALUE_NOT_SET)
        self.created_at = kwargs.get('created_at', self.VALUE_NOT_SET)
        self.updated_at = kwargs.get('updated_at', self.VALUE_NOT_SET)
        self.attributes = {'type': 'Document'}
