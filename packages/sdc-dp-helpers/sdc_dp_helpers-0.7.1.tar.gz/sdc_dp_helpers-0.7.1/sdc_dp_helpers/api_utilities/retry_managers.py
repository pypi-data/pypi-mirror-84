...
def request_handler(
    ...
    """
        ...
        Args:
            wait (float, optional): [description]. Defaults to 100 seconds for GoogleAnalytics. Initial delay between retry attempts in seconds
            backoff_factor (float, optional): [description]. Defaults to 0.1. Multiplier used to further randomize delay
            backoff_method (str, optional): [description]. Defaults to 'random'. hHow to apply backoff
        return:
            wrapped function's response
    """
