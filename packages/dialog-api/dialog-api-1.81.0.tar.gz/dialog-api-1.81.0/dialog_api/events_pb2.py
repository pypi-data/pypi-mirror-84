...
_EVENT = _descriptor.Descriptor(
  ...
  nested_types=[_EVENT_MENTION, _EVENT_REACTIONS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_EVENT.fields_by_name['id'].message_type = definitions__pb2._UUIDVALUE
