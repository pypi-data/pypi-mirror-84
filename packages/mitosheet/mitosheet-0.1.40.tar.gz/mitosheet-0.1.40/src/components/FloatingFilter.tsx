...
import { FilterCondition, NumberFilterCondition, StringFilterCondition } from './modals/FilterModal'
...
type FloatingFilterProps = {
    ...
    columnFilterInfo: StringFilterCondition | NumberFilterCondition;
    displayName: string;
}

type FloatingFilterState = {

}

export default class FloatingFilter extends Component<FloatingFilterProps, FloatingFilterState > {
    constructor(props : FloatingFilterProps) {
      super(props);
    ...
    return (
        <div>
          <div onClick={() => {this.props.setModal({ 
              ...
              columnHeader: this.props.displayName,
              columnFilterInfo: this.props.columnFilterInfo,
            })
            }}>
            {this.props.columnFilterInfo.condition === FilterCondition.NONE && 
