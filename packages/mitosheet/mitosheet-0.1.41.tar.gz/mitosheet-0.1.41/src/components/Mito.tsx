...
import FilterModal, {NumberFilterCondition, StringFilterCondition} from './modals/FilterModal';
...
export interface SheetColumnFilterMap {
    [column: string] : StringFilterCondition | NumberFilterCondition
}
        ...
        switch(this.state.modalInfo.type) {
            ...
            case ModalEnum.Filter : return (
                <FilterModal
                    ...
                    send={this.props.send}
                    selectedSheetIndex={this.state.selectedSheetIndex}
                    columnFilterInfo={this.state.modalInfo.columnFilterInfo}
                />
            )
