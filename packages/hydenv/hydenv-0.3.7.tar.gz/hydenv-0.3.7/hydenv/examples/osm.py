...
class HydenvOSMExamples:
    ...
    def run(self, boundary, attribute, value=None, dry=False, save=None, quiet=True):
        # first build the query
        value = '=%s' % value if value is not None else ''
        query = BY_AREA.format(boundary_name=boundary, attribute=attribute, value=value)
