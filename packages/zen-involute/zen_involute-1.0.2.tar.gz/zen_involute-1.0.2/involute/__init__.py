...
class GearContext:
    ...
    def _calc_raw_involute_angle(self, radius):
        t = sqrt((radius / self._base_radius) ** 2 - 1)
        return t - atan(t)

    def _calc_involute_angle(self, radius):
...
if __name__ == "__main__":
    ...
    gear1Context = gear_style.create_context(12)
    gear2Context = gear_style.create_context(32)
