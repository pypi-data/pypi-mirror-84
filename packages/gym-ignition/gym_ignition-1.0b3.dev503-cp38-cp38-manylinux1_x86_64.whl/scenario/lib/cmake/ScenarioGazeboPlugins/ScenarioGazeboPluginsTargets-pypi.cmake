...
set_target_properties(ScenarioGazeboPlugins::ECMSingleton PROPERTIES
  IMPORTED_LOCATION_PYPI "${_IMPORT_PREFIX}/scenario/lib/libECMSingleton.so"
  IMPORTED_SONAME_PYPI "libECMSingleton.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ScenarioGazeboPlugins::ECMSingleton )
list(APPEND _IMPORT_CHECK_FILES_FOR_ScenarioGazeboPlugins::ECMSingleton "${_IMPORT_PREFIX}/scenario/lib/libECMSingleton.so" )
