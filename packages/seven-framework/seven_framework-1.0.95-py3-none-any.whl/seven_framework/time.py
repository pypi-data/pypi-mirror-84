...
class TimeHelper:
    ...
    @classmethod
    def difference_datetime(self, minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S'):
        """
    ...
    @classmethod
    def difference_days(self, minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S'):
        """
        ...
        @last_editors: ChenXiaolei
        """
        return self.difference_datetime(minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S').days

    @classmethod
    def difference_seconds(self, minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S'):
        """
        ...
        @last_editors: ChenXiaolei
        """
        return int(self.difference_datetime(minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S').total_seconds())

    @classmethod
    def difference_minutes(self, minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S'):
        """
        ...
        @last_editors: ChenXiaolei
        """
        return int(self.difference_seconds(minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S')/60)

    @classmethod
    def difference_hours(self, minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S'):
        """
        ...
        @last_editors: ChenXiaolei
        """
        return int(self.difference_seconds(minuend_time, subtracter_time, format='%Y-%m-%d %H:%M:%S')/60/60)