...
class CreateUpdateFieldsWithVersion:
    ...
    created_at: datetime = db.Column(db.DateTime(), index=True, default=datetime.utcnow)
    updated_at: datetime = db.Column(db.DateTime(), index=True, default=datetime.utcnow, onupdate=datetime.utcnow)
    created_by: int = db.Column(db.Integer, default=1)
...
class ResourceMixin(CreateUpdateFieldsWithVersion, object):
    __table__: Table
    query: BaseQuery
