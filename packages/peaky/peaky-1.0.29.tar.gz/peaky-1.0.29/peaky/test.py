...
fit, err, snr, fun, yf = fit_voigt(range(n), y, peak_ratio = 1/5, background = 1)
plt.plot(fun[0](np.arange(len(y))), c = "tab:blue", zorder = 1)
plt.show(block = 0)
