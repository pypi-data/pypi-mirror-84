...
class FundDataManager(DataManager):
    ...
    def fund_analysis_by_stock_factors(self, fund_id: str, factor_names: Tuple[str], universe: str = 'default') -> pd.DataFrame:
        '''对基金计算因子暴露'''
        try:
            try:
    ...
    def index_analysis_by_stock_factors(self, index_id: str, factor_names: Tuple[str]) -> pd.DataFrame:
        '''对指数计算因子暴露'''
        try:
