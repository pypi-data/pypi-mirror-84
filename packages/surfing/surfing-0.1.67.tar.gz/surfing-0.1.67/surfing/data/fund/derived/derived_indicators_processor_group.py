...
class FundIndicatorProcessorGroup:
    ...
    _REPLACE_DICT = {'stock': 'csi_stockfund', 'bond': 'csi_boodfund', 'mmf': 'mmf', 'QDII': 'csi_f_qdii', 'mix': 'csi_f_hybrid'}
    ...
    def init(self, end_date: str, is_print_time: bool=False):
        ...
        fund_nav: pd.DataFrame = self._basic_api.get_fund_nav_with_date(start_date, end_date, self._fund_list.fund_id.tolist())  #, fund_list = f_l)
