...
class EmRawDataDownloader:
    ...
    def em_fund_status(self, end_date: str, is_history: bool = True):
        try:
            ...
            # TODO: 这里可能使用QANALNETASSET和QANALNETSHARE，即报告期期末基金资产净值和报告期期末基金份额净值的数据会更准确一些
            ...
            if data1 is None:
                ...
                return False
            data2 = self._em_css_wrapper(fund_list, 'PURCHSTATUS,REDEMSTATUS,LPLIMIT,OTCLPLIMITJG,TRADESTATUS,UNITTOTAL', f'TradeDate={end_date},SHAREOBJECT=1,Ispandas=1')
            if data2 is None:
            ...
            if not is_history:
                ...
                if now_df is not None:
                    ...
                    df = df.merge(now_df, how='left', on=['CODES', 'FUNDSCALE', 'UNITTOTAL', 'LPLIMIT', 'OTCLPLIMITJG', 'OTCLPLIMITGR', 'PURCHSTATUS', 'REDEMSTATUS', 'TRADESTATUS', 'PCHMINAMT', 'REDMMINAMT'], indicator=True, validate='one_to_many')
    ...
    def em_stock_fin_fac(self, end_date: str, stock_list=None):
        if stock_list is None:
            # 获取所有A股股票的ID, 功能函数-板块成分
            # http://quantapi.eastmoney.com/Cmd/Sector?from=web
            # 全部A股股票
        ...
        df_no_param = self._em_css_wrapper(stock_list,
                                              ...
                                              BPS,MBREVENUE,MBCOST,BALANCESTATEMENT_9,BALANCESTATEMENT_25,BALANCESTATEMENT_31,BALANCESTATEMENT_46,BALANCESTATEMENT_93,BALANCESTATEMENT_103,BALANCESTATEMENT_141,BALANCESTATEMENT_195,\
                                              BALANCESTATEMENT_140,INCOMESTATEMENT_9,INCOMESTATEMENT_48,INCOMESTATEMENT_56,INCOMESTATEMENT_60,INCOMESTATEMENT_61,INCOMESTATEMENT_83,INCOMESTATEMENT_85,INCOMESTATEMENT_127,\
                                              INCOMESTATEMENT_14,CASHFLOWSTATEMENT_9,CASHFLOWSTATEMENT_39,CASHFLOWSTATEMENT_59,CASHFLOWSTATEMENT_70,CASHFLOWSTATEMENT_77,CASHFLOWSTATEMENT_82,CASHFLOWSTATEMENT_86,CASHFLOWSTATEMENT_87,\
                                              CASHFLOWSTATEMENT_88,CASHFLOWSTATEMENT_89',
