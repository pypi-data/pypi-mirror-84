...
class MixLiquidityFactor(LiquidityFactor):
    ...
    def calc(self):
        self._factor = Turnover30DFactor().get_normalized(self.universe) + Turnover60DFactor().get_normalized(self.universe) + Turnover90DFactor().get_normalized(self.universe)
