...
class FundDataManager(DataManager):
    ...
    def fund_analysis_by_stock_factors(self, fund_id: str, factor_names: Tuple[str]) -> pd.DataFrame:
        try:
            try:
            ...
            return
        return StockFactorApi.decomp_ret(fund_nav.pct_change(), factor_names)
