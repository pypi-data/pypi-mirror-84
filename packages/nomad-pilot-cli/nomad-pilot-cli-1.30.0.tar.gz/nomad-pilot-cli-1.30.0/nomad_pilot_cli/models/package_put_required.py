...
class PackagePutRequired(object):
    ...
    def __init__(self, tracking_reference=None, status='UNPROCESSED', local_vars_configuration=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["UNPROCESSED", "PACKED", "PROCESSED", "CANCEL"]  # noqa: E501
