...
The sources for xls2xlsx can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/snoopyjc/xls2xlsx
.. _tarball: https://github.com/snoopyjc/xls2xlsx/tarball/master
