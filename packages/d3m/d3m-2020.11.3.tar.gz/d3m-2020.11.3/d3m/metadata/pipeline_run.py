...
def _validate_pipeline_run_timestamps(pipeline_run: typing.Dict, parent_start: datetime.datetime = None, parent_end: datetime.datetime = None) -> None:
    ...
    if start is None:
        raise exceptions.InvalidPipelineRunError("Invalid start timestamp in pipeline run.")
    if end is None:
        raise exceptions.InvalidPipelineRunError("Invalid end timestamp in pipeline run.")
