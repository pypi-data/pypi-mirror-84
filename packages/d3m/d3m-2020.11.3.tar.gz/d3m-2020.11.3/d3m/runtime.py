...
class Runtime:
    ...
    def _run_subpipeline(self, step: pipeline_module.SubpipelineStep) -> None:
        ...
        self.pipeline_run.add_subpipeline_step(result.pipeline_run)  # type: ignore
        result.check_success()
    ...
    def _create_pipeline_primitive(self, primitive_class: typing.Type[base.PrimitiveBase], hyperparams: hyperparams_module.Hyperparams) -> base.PrimitiveBase:
        ...
        if 'random_seed' in arguments:
            self.pipeline_run.set_primitive_step_random_seed(self.current_step, arguments['random_seed'])  # type: ignore
    ...
    def _run_primitive(self, step: pipeline_module.PrimitiveStep) -> None:
        ...
        self.pipeline_run.add_primitive_step(step)  # type: ignore
        ...
        if self.phase == metadata_base.PipelineRunPhase.FIT:
            self.pipeline_run.set_primitive_step_hyperparams(self.current_step, hyperparams, pipeline_hyperparams)  # type: ignore
    ...
    def _call_primitive_method(self, method: typing.Callable, arguments: typing.Dict) -> typing.Any:
        ...
        pipeline_run_method_call_id = self.pipeline_run.add_method_call_to_primitive_step(self.current_step, method_name)  # type: ignore

        callback = self.pipeline_run.get_method_call_logging_callback(pipeline_run_method_call_id)  # type: ignore
        ...
        try:
            ...
            with utils.redirect_to_logging(logger=redirect_logger, pass_through=True):
                with utils.global_randomness_warning():
                    self.pipeline_run.method_call_started(pipeline_run_method_call_id)  # type: ignore

                    try:
                        result = method(**arguments)
                    except Exception as error:
                        self.pipeline_run.method_call_failed(pipeline_run_method_call_id, traceback.format_exc())  # type: ignore

                        raise error

                    self.pipeline_run.method_call_successful(pipeline_run_method_call_id)  # type: ignore
        ...
        self.pipeline_run.set_method_call_result_metadata(pipeline_run_method_call_id, result)  # type: ignore
    ...
    def _do_run_step(self, step: pipeline_module.StepBase) -> None:
        self.pipeline_run.step_started(self.current_step)  # type: ignore
        ...
        try:
            ...
            self.pipeline_run.step_failed(self.current_step, traceback.format_exc())  # type: ignore
        ...
        self.pipeline_run.step_successful(self.current_step)  # type: ignore
    ...
    def _run(
        ...
        self.pipeline_run.run_started()  # type: ignore

        error: typing.Optional[Exception] = None
        try:
            self._do_run()
        except Exception as run_error:
            self.pipeline_run.run_failed(traceback.format_exc())  # type: ignore

            error = run_error

        if error is None:
            self.pipeline_run.run_successful()  # type: ignore

            self._populate_output_values()

            if self.is_standard_pipeline:
                self.pipeline_run.set_predictions(self.data_values['outputs.0'])  # type: ignore
        ...
        return Result(pipeline_run, values, error)  # type: ignore
...
def fit(
    ...
    if data_result is not None:
        ...
        combine_pipeline_runs(
            result.pipeline_run, data_pipeline_run=data_result.pipeline_run,
            fold_group_uuid=fold_group_uuid, fold_index=0,
        )
...
def evaluate(
    ...
    for fold_index, (train_inputs, test_inputs, score_inputs) in enumerate(zip(*outputs)):
        ...
        predictions, produce_result = produce(fitted_pipeline, [test_inputs])  # type: ignore
        ...
        scores, score_result = score(
            predictions, [score_inputs], scoring_pipeline=scoring_pipeline, problem_description=problem_description, metrics=metrics,  # type: ignore
        ...
        all_scores.append(scores)  # type: ignore
...
def combine_pipeline_runs(
    ...
    if fold_group_uuid is not None:
        standard_pipeline_run.set_fold_group(fold_group_uuid, fold_index)  # type: ignore

    if scoring_pipeline_run is not None:
        standard_pipeline_run.set_scoring_pipeline_run(scoring_pipeline_run, score_inputs)

    if scores is not None:
        standard_pipeline_run.set_scores(scores, metrics)  # type: ignore
...
def fit_handler(
    ...
    if getattr(arguments, 'output', None) is not None:
        ...
        predictions.to_csv(arguments.output)  # type: ignore
...
def score_handler(
    ...
    # Modifies "produce_result.pipeline_run" in-place.
    combine_pipeline_runs(
        produce_result.pipeline_run, scoring_pipeline_run=score_result.pipeline_run, score_inputs=score_inputs if data_result is None else None,
    )
    ...
    if getattr(arguments, 'scores', None) is not None:
        scores.to_csv(arguments.scores)  # type: ignore
...
def fit_produce_handler(
    ...
    predictions, produce_result = produce(fitted_pipeline, test_inputs, expose_produced_outputs=expose_produced_outputs)  # type: ignore
...
def fit_score_handler(
    ...
    scores, score_result = score(
        predictions, score_inputs,  # type: ignore
        scoring_pipeline=scoring_pipeline,
        problem_description=problem_description,
        metrics=metrics,
        predictions_random_seed=fitted_pipeline.random_seed,
