...
LOGS_ANOMALIES_WEBHOOK_TABLE = 'logs.anomalies_webhook'
LOGS_ERRORS_TABLE = 'logs.errors'

DEV_ANOMALIES_TABLE = 'dev.anomalies.items'
DEV_LOGS_ANOMALIES_WEBHOOK_TABLE = 'dev.logs.anomalies_webhook'
...
def insert_anomalies_webhook_log(timestamp,
  ...
  table_name = LOGS_ANOMALIES_WEBHOOK_TABLE if not is_dev_env else DEV_LOGS_ANOMALIES_WEBHOOK_TABLE
