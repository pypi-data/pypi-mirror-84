...
class TestAutoAIRemote(unittest.TestCase):
    ...
    asset_id = 'ac9f5646-a9b2-4fbf-81fc-9d289f63566f'
    ...
    def setUpClass(cls) -> None:
        ...
        #cls.asset_id, cls.data_location, _ = setup_nfs_env(cls.wml_credentials, 'iris_dataset.csv')
        #print(cls.asset_id, cls.data_location)
