...
setuptools.setup(
    executable=True,
    name="py-msyh",  # Replace with your own username
    version=version,
    author="Peiiii",
    author_email="1535376447@qq.com",
    description="python utils to use font msyh.ttf in a minute.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="http://github.com/Peiiii/py_msyh",
    packages=packages,
    package_dir={'pymsyh': 'pymsyh'},
    install_requires=[
        'pillow'
    ],
