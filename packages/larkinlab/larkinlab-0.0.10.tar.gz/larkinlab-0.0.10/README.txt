...
-------------------------------------
llex.corr_ex(df, min_corr, fig_size, colors)
        
The corr_ex function returns both a pearson correlation values chart and a heatmap of said
correlation values, for all of the columns in the dataframe passed through it. 
