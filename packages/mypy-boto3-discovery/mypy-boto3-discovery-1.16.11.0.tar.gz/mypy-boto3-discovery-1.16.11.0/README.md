...
[boto3.ApplicationDiscoveryService 1.16.11](https://boto3.amazonaws.com/v1/documentation/api/1.16.11/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
