...
def get_html_string(graphs, tagrec, tagLinks):
    ...
    """
        ...
        + """<div class="reportDiv">"""
        + execution_status 
        + """ <br><label for="tab2" style="background:  darkkhaki !important; color:rgb(15, 61, 16) !important;">Summary Details Per Job</label><br><br>"""
        + per_job_status
        + """ <br><label for="tab2" style="background:  darkkhaki !important; color:rgb(15, 61, 16) !important;">Summary Details Per Tag</label><br><br>"""
        + per_tag_status
...
def get_recommendations(df, failed_blocked, topfailedTCNames, failed, passed, blocked, name, bool):
    ...
    per_job_status = pandas.DataFrame.from_dict(perJob)
    per_job_status = per_job_status.to_html(
        classes="mystyle",
        table_id="report",
        index=False,
        render_links=True,
    ...
    per_job_status = style_df_email(per_job_status)
    ...
    per_tag_status = pandas.DataFrame.from_dict(perTag)
    per_tag_status = per_tag_status.to_html(
        classes="mystyle",
        table_id="report",
        index=False,
        render_links=True,
    ...
    per_tag_status = style_df_email(per_tag_status)
