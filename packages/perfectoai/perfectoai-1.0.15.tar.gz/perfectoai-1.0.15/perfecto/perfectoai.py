...
def style_df_email(df):
    return (
        ...
        .replace(
            "<td>",
            '<td style="box-sizing: border-box; font-size: 12px; position: relative; padding: 5px; min-width: 20%; color: black; border-left: 1px solid #333; border-right: 1px solid #333; background: rgba(255, 253, 207, 0.58);" width="15%" align="center">',
        )
    )
...
def get_recommendations(df, failed_blocked, topfailedTCNames, failed, passed, blocked, name, bool):
    ...
    if(per_job.shape[0] > 0):
        ...
        per_job_status = """ <br><label for="tab2" style="background:  darkkhaki !important; color:rgb(15, 61, 16) !important;">Summary Details Per Job</label><br><br>""" + style_df_email(per_job)
        per_job_status_email = style_df_email(per_job)
        per_job_status_email = """ <br><div """ + header+ """><center><label for="tab2" style="background:  darkkhaki !important; color:black !important;font-weight:bold;">Summary details Per Job</label></center></div><br><br>""" + per_job_status_email
    ...
    if(per_tag.shape[0] > 0):
        ...
        per_tag_status =  """ <br><label for="tab2" style="background:  darkkhaki !important; color:rgb(15, 61, 16) !important;">Summary Details Per Tag</label><br><br>""" + style_df_email(per_tag)
        per_tag_status_email = style_df_email(per_tag)
        per_tag_status_email = """ <br><div """ + header+ """><center><label for="tab2" style="background:  darkkhaki !important; color:black !important;font-weight:bold;">Summary details Per Tag</label></center></div><br><br>""" + per_tag_status_email
