...
class AwsLoadBalancerController(
    ...
    def __init__(
        ...
        *,
        ...
        :param args: Another Args for aws-load-balancer-controller. Default: - None
        :param env: Another Args for aws-load-balancer-controller. Default: - None
        :param image: Default image for aws-load-balancer-controller. Default: - docker.io/amazon/aws-aws-load-balancer-controller:v1.1.9
        :param labels: Extra labels to associate with resources. Default: - none
        :param namespace: Default Namespace for aws-load-balancer-controller. Default: - kube-system
        :param replicas: Replicas for aws-load-balancer-controller. Default: - 1
        :param service_account_name: Default Service Account Name for aws-load-balancer-controller. Default: - aws-load-balancer-controller
        """
...
class CertManager(
    ...
    def cert_manager_config(self) -> typing.Any:
        return jsii.invoke(self, "certManagerConfig", [])
