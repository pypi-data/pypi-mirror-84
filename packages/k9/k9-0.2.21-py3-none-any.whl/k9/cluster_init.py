...
from k9.helm import helm_install, helm_ls, helm_repo_add, helm_repo_update
...
def install_sonarqube(params: dict, namespace: str = 'cluster-tools'):
    """
...
def install_prometheus(params: dict, namespace: str = 'cluster-tools'):
    """
...
def install_grafana(params: dict, namespace: str = 'cluster-tools'):
    """
...
def install_cluster_tools(params: dict, namespace: str = 'cluster-tools'):
    """
