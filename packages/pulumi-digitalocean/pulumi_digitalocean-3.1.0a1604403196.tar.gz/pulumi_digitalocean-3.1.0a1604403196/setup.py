...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.1.0-alpha.1604403196+41c17ddc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.1.0-alpha.1604403196+41c17ddc`
                """)
            else:
                raise
