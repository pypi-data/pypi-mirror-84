...
from albion_similog.well_correlation import algo_correlation
...
def run(data, outputdir, experiment=None):
    ...
    algo_corr.prepare_logs()
    algo_corr.run_algorithm_unsupervised()
    ...
    algo_corr.results_unsupervised.to_csv(tops_unsupervised_filepath, index=False)
