...
class TextSetup:
    def __init__(self, text):
        self.__t = text
        self.__text = self.__t
        self.dtype_str = isinstance(self.__text, str)
        self.dtype_list = isinstance(self.__text, list)


class SwachhText(TextSetup):
    def __init__(self, TextSetup):
        self.__t = TextSetup._TextSetup__t
        self.__text = self.__t
        self.dtype_str = isinstance(self.__text, str)
        self.dtype_list = isinstance(self.__text, list)
    ...
    def remove_url(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'http\S+', '', self.__text)
            return ntext
    ...
    def remove_html(self):
        ...
        if self.dtype_list:
            ...
            soup = BeautifulSoup(unescape(self.__text), 'lxml')
            ntext = soup.get_text()
            return ntext
    ...
    def remove_line_break(self):
        ...
        if self.dtype_list:
            ...
            ntext = self.__text.replace('\r', ' ').replace('\n', ' ')
            return ntext
    ...
    def remove_mention(self):
        ...
        if self.dtype_list:
            ...
            no_mention = ' '.join(re.sub('([@][A-Za-z0-9._:-]+)', ' ', self.__text).split())
            ntext = no_mention
            return ntext
    ...
    def map_contraction(self):
        ...
        if self.dtype_list:
            ...
            ntext = contractions.fix(self.__text)
            return ntext
    ...
    def replace_emoji(self):
        ...
        if self.dtype_list:
            ...
            ntext = emoji.demojize(self.__text, delimiters=('', ' '))
            return ntext
    ...
    def remove_emoji(self):
        ...
        if self.dtype_list:
            ...
            allchars = [str for str in self.__text]
            emoji_list = [c for c in allchars if c in emoji.UNICODE_EMOJI]
            strip_text = ' '.join([str for str in self.__text.split() if not any(j in str for j in emoji_list)])
            ntext = strip_text
            return ntext
    ...
    def remove_accented_char(self):
        ...
        if self.dtype_list:
            ...
            ntext = unicodedata.normalize('NFKD', self.__text).encode('ascii', 'ignore').decode('utf-8', 'ignore')
            return ntext
    ...
    def remove_non_ascii(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'[^\x00-\x7F]+', ' ', self.__text)
            return ntext
    ...
    def remove_num_no_comma(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'(?<!\B)[,](?!\B)', '', self.__text, 0)
            return ntext
    ...
    def replace_number(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'(\d+)', lambda x: num2words.num2words(int(x.group(0))), self.__text)
            return ntext
    ...
    def remove_number(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'[0-9]+', '', self.__text, 0)
            return ntext
    ...
    def extract_hashtag(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.findall('#\w+', self.__text)
            return ntext
    ...
    def remove_hashtag(self):
        ...
        if self.dtype_list:
            ...
            ntext = ' '.join(re.sub('([#][A-Za-z0-9._:-]+)', ' ', self.__text).split())
            return ntext
    ...
    def remove_punctuation(self):
        ...
        if self.dtype_list:
            ...
            ntext = self.__text.translate(str.maketrans(string.punctuation, ' ' * len(string.punctuation))).replace(' '*4, ' ').replace(' '*3, ' ').replace(' '*2, ' ').strip()
            return ntext
    ...
    def keep_alphabet(self):
        ...
        if self.dtype_list:
            ...
            ntext = re.sub(r'[^a-zA-Z]', ' ', self.__text, 0)
            return ntext
    ...
    def tokenize_text(self):
        ...
        if self.dtype_list:
            ...
            ntext = word.tokenize(self.__text)
            return ntext
...
class SwachhSabText(SwachhText):
    def __init__(self, SwachhText):
        self.__t = SwachhText._SwachhText__t
        self.__text = self.__t
        self.dtype_str = isinstance(self.__text, str)
        self.dtype_list = isinstance(self.__text, list)
    ...
    def clean_text(self, verbose=False, **kwargs):
        ...
        if 'stemming' in kwargs and kwargs['stemming']:
            if verbose:
                print('Stemming...')
            self.__text = SwachhText.stemming(self)

        if 'lemmatization' in kwargs and kwargs['lemmatization']:
            if verbose:
                print('Lemmatizing...')
            self.__text = SwachhText.lemmatize_with_postag(self)
