...
setuptools.setup(
    ...
    install_requires=['language-check', 'asn1crypto', 'backports.functools-lru-cache', 'click', 'docopt', 'enum34', 'inexactsearch',
          'beautifulsoup4', 'contractions', 'pycontractions', 'regex', 'emoji', 'html2text', 'html5lib', 'MarkupSafe',
