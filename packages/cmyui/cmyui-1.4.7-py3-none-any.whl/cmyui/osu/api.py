...
async def test():
    client_id = 3190
    client_secret = 'UEPeSpqHDYu840hXTwW02e5nUtc5uHYJwO7592d9'

    async with OsuAPIWrapper(client_id, client_secret) as osu:
        x = await osu.get_user(1001)
        ...
