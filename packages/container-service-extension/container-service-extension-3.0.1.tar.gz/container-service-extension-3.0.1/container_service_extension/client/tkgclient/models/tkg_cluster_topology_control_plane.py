...
class TkgClusterTopologyControlPlane(object):
    ...
    def __init__(self, _class=None, count=None, storage_class=None):  # noqa: E501
        """TkgClusterTopologyControlPlane - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def _class(self):
        """Gets the _class of this TkgClusterTopologyControlPlane.  # noqa: E501
        ...
        :return: The _class of this TkgClusterTopologyControlPlane.  # noqa: E501
        :rtype: str
        """
        return self.__class
    ...
    def _class(self, _class):
        """Sets the _class of this TkgClusterTopologyControlPlane.

        Specifies the name of the VirtualMachineClass that describes the virtual hardware settings to be used each node in the pool. This controls the hardware available to the node (CPU and memory) as well as the requests and limits on those resources. Use a VirtualMachineClass that has been associated with the placement-policy specified above (see placementPolicy element).   # noqa: E501

        :param _class: The _class of this TkgClusterTopologyControlPlane.  # noqa: E501
        :type: str
        """
        if _class is None:
    ...
    @property
    def count(self):
        """Gets the count of this TkgClusterTopologyControlPlane.  # noqa: E501

        Specifies the number of control plane nodes. The control plane must have an odd number of nodes. It's an integer that is either 1 or 3.   # noqa: E501

        :return: The count of this TkgClusterTopologyControlPlane.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this TkgClusterTopologyControlPlane.

        Specifies the number of control plane nodes. The control plane must have an odd number of nodes. It's an integer that is either 1 or 3.   # noqa: E501

        :param count: The count of this TkgClusterTopologyControlPlane.  # noqa: E501
        :type: int
        """
        if count is None:
    ...
    def storage_class(self):
        """Gets the storage_class of this TkgClusterTopologyControlPlane.  # noqa: E501
        ...
        :return: The storage_class of this TkgClusterTopologyControlPlane.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_class(self, storage_class):
        """Sets the storage_class of this TkgClusterTopologyControlPlane.

        Identifies the storage class to be used for storage of the disks which store the root file systems of the control plane nodes. Use a storage class that has been associated with the placement-policy specified above (see placementPolicy element).   # noqa: E501

        :param storage_class: The storage_class of this TkgClusterTopologyControlPlane.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TkgClusterTopologyControlPlane):
            return False
