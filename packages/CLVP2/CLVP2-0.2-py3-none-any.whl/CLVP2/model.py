...
class CNN_LSTM_Model():
    ...
    def fit_evaluate_model(self,model,batch_size):
        ...
        checkpoint_filepath = 'test_model'
        ...
        performance = model.evaluate([self.x_test_non_time_series,self.x_test_time_series], self.y_test)
        

        try:
            os.remove("checkpoint")
            os.remove("test_model.data-00000-of-00001")
            os.remove("test_model.index")
        except:
            pass
    ...
    def fit_best_model(self,model,batch_size):
        ...
        try:
            os.remove("checkpoint")
            os.remove("best_model.data-00000-of-00001")
            os.remove("best_model.index")
        except:
            pass

        return model,best_performance,1
