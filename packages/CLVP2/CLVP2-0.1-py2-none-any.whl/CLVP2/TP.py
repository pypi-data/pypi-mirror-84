            ...
            if x['isSuccess']:
                ...
                if s1['isSuccess'] and s2['isSuccess']:
                    ...
                    if results['isSuccess']:
                        ...
                        return {"model_url":results['data'],"scaler1_url":s1['data'],"scaler2_url":s2['data'],"non_time_series_features":x['data'][2]}


                    else:
                        return print(results['error']['code'])

                else:
                    if not s1['isSuccess']:
                        return print(s1['error']['code'])
                    else:
                        return print(s2['error']['code'])


                    
            else:
                return print(x['error']['code'])
                    
        else:
            return print(df['error']['code'])
