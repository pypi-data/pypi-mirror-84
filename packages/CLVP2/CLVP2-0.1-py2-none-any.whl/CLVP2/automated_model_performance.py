...
class   automated_parameter_selection():
    ...
    def __init__(self,x_train_non_time_series,x_train_time_series,x_validation_non_time_series,x_validation_time_series,x_test_non_time_series,x_test_time_series,y_train,y_validation,y_test):
        ...
        self.CNN_Filters_2 = 2*4
        self.CNN_Filters_3 = 64
        self.dense_layer_1 = 120
        self.dense_layer_2 = 60
        self.dense_layer_3 = 30
        self.batch_size = 32
        ...
        for loop in range(0,50):
            ...
            if self.train:
                ...
                try:
                   ...
                   results =self.CNN_LSTM_model.fit_evaluate_model(model,self.batch_size)
    ...
    def train_save_best_model(self,best_parameters):
        ...
        while train==0:
            try:    
                ...
                best_model,best_performance,train = self.CNN_LSTM_model.fit_best_model(model,best_parameters[9])
