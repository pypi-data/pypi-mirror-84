...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.29.0-alpha.1604070213+07dfd122'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.29.0-alpha.1604070213+07dfd122`
                """)
            else:
                raise
