...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.30.0-alpha.1604603116+e3d5465b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.30.0-alpha.1604603116+e3d5465b`
                """)
            else:
                raise
