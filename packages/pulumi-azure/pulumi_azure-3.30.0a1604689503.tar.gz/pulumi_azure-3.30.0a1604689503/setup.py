...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.30.0-alpha.1604689503+eab8eb9c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.30.0-alpha.1604689503+eab8eb9c`
                """)
            else:
                raise
