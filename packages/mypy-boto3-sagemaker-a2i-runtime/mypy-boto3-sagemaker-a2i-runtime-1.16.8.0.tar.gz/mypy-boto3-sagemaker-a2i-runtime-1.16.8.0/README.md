...
[boto3.AugmentedAIRuntime 1.16.8](https://boto3.amazonaws.com/v1/documentation/api/1.16.8/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime) service
compatible with
