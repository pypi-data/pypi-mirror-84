...
def parse_args():
    parser = argparse.ArgumentParser(prog='OrthoNeighborhood', description='Track Synteny of Orthologs Across Genomes')

    parser.add_argument('--tabular-ortholog-groups', dest='ogtable', metavar='<orthology_table>',
                        type=argparse.FileType('rt'), #required=True,
                    help='path to mapping file with format genom_id<tab>sequence_identifier<tab>ortholog_group_identifier')
