THIS PACKAGE IS DEPRECATED, PLEASE USE https://pypi.org/project/python-imagesearch-drov0/1.1.0/ INSTEAD 

(notice the typo, python-imageseach != python-imagesearch)
