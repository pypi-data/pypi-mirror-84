...
class LegendItem:
    ...
    def generate(self, f: TextIO, x: str, y: str, width: Real) -> None:
...
class LegendNode(LegendItem):
    ...
    def __init__(self, nodetype, id_=None, scale: Real = 1):
        super().__init__(id_)
...
class LegendArrow(LegendItem):
    ...
    def __init__(self, edge_colors: Mapping[str, str], tip: str, scale: Real = 1):
        super().__init__(tip)
        self.tip = 'tip_' + tip
        self.scale = scale
