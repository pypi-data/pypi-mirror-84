...
def add_MetricServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMetricSummary': grpc.unary_stream_rpc_method_handler(
                    servicer.GetMetricSummary,
                    request_deserializer=metric__pb2.MetricSummaryRequest.FromString,
                    response_serializer=metric__pb2.MetricSummary.SerializeToString,
            ),
    }
...
class MetricService(object):
    ...
    def GetMetricSummary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.metric.MetricService/GetMetricSummary',
            metric__pb2.MetricSummaryRequest.SerializeToString,
            metric__pb2.MetricSummary.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
