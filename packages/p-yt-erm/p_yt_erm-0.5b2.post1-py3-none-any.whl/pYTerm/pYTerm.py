...
class player():
    ...
    __VERSION_PRIME = metadata.version("p-yt-erm")  # version number -a
    ...
    NOTICE = f"""player branch "{__VERSION_BRANCH}", version {__VERSION_PRIME}, edited @ {__DATE},
...
This software is released under the "{__LICENSE}" license, please read before usage.\n"""
    NOTICEFR = f"""pyterm branche "{__VERSION_BRANCH}", version {__VERSION_PRIME}, édité le {__DATE},
