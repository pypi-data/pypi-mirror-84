    ...
    **kwargs : keyword arguments
    ...
    def predict(self, data, key,#pylint: disable=too-many-branches, invalid-name, too-many-statements
        ...
        block_size : int, optional
            ...
            Valid only for RandomForest and HybridGradientBoostingTree model
        ...
        missing_replacement : str, optional
            ...
            Valid only for RandomForest and HybridGradientBoostingTree models.
        ...
        attribution_method : {'no', 'saabas', 'tree-shap'}, optional
            ...
            Valid only for tree-based models, i.e. Decision Tree, Random Forest and Hybrid Gradient Boosting Tree models.
