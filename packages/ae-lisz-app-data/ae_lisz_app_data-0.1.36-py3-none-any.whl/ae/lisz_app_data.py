...
The Lisz demo app is managing a recursive item tree that can be used e.g. as to-do or
shopping list.
...
class LiszDataMixin(ABC):
    ...
    def import_file_info(file_path: str, node_name: str = "") -> NodeFileInfo:
        ...
        err_msg, _, node = flow_path_items_from_text(file_content)   # ignore optional flow path given in 1st line
