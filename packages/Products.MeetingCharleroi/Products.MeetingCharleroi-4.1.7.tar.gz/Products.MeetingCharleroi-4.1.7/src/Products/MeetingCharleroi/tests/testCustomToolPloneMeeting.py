...
from Products.MeetingCommunes.tests.testCustomToolPloneMeeting import testCustomToolPloneMeeting as mctctp


class testCustomToolPloneMeeting(MeetingCharleroiTestCase, mctctp):
