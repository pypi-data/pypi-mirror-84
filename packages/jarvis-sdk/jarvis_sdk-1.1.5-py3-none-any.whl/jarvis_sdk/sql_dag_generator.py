...
# Globals
#
_current_version = "2020.09.15.001"
...
def check_dag_concurrency(dag_run_id, max_active_runs, firestore_com_id):
    ...
    while retry < 3:
        ...
        try:
            ...
            # ETCD infos
            #
            etcd_host_address = os.environ["TAILER_ETCD_HOST"]
            etcd_host_port = 2379
            etcd_user = "root"
            etcd_secret = os.environ["TAILER_ETCD_SECRET"]
...
def initialize(dag_run_id, firestore_com_id):
    ...
    #
    data_read, message = read_from_firestore(collection, conf_doc_id)
    ...
    #
    try:
        max_active_runs = data_read["configuration"]["max_active_runs"]
    except Exception:
        max_active_runs = 1
    ...
    #
    conf_context = {}
    conf_context["configuration_context"] = data_read
    ...
    if dag_activated is True:
        ...
        try:
            ...
            # asyncio.run(check_dag_concurrency(dag_run_id=dag_run_id, max_active_runs=max_active_runs, firestore_com_id=firestore_com_id))
    ...
    #
    return dag_activated, data_read["account"], data_read["environment"], False
...
"""
    ...
    #
    pst = pytz.timezone("UTC")
    dag_execution_date = str(datetime.datetime.now(pst).isoformat(\"T\"))
    # dag_execution_date =  datetime.datetime.now().isoformat(\"T\")
