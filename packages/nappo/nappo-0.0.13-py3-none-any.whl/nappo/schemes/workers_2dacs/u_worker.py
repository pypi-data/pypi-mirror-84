...
class UWorker:
    ...
    its actor_critic model. Updated weights are synchronously sent back
    to gradient workers.
    ...
    def step(self):
        ...
        # Update info dict
        info = {k: v/self.num_workers if v != "collected_samples" else v for k, v in step_metrics.items()}
