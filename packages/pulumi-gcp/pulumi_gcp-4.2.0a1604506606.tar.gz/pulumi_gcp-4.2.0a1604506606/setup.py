...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.2.0-alpha.1604506606+d9fb2aa7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.2.0-alpha.1604506606+d9fb2aa7`
                """)
            else:
                raise
