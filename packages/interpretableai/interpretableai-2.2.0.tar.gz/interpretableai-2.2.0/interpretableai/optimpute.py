...
def impute(*args, **kwargs):
    ...
    Julia Equivalent:
    `IAI.impute <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.impute>`
...
def impute_cv(*args, **kwargs):
    ...
    Julia Equivalent:
    `IAI.impute_cv <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.impute_cv>`
...
class ImputationLearner(UnsupervisedLearner):
    ...
    Julia Equivalent:
    `IAI.ImputationLearner <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.ImputationLearner>`
    ...
    def fit_transform(self, *args, **kwargs):
        ...
        Similar to calling
        `fit <https://docs.interpretable.ai/v2.0.0/IAI-Python/reference/#fit-Tuple%7BLearner%7D>`
        followed by
        `transform <https://docs.interpretable.ai/v2.0.0/IAI-Python/reference/#transform%7BImputationLearner%7D>`
        .

        Julia Equivalent:
        `IAI.fit_transform! <https://docs.interpretable.ai/v2.0.0/IAIBase/reference/#IAI.fit_transform!>`
    ...
    def transform(self, *args, **kwargs):
        ...
        Julia Equivalent:
        `IAI.transform <https://docs.interpretable.ai/v2.0.0/IAIBase/reference/#IAI.transform>`
...
class OptKNNImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptKNNImputationLearner <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.OptKNNImputationLearner>`
...
class OptSVMImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptSVMImputationLearner <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.OptSVMImputationLearner>`
...
class OptTreeImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.OptTreeImputationLearner <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.OptTreeImputationLearner>`
...
class SingleKNNImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.SingleKNNImputationLearner <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.SingleKNNImputationLearner>`
...
class MeanImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.MeanImputationLearnerer <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.MeanImputationLearner>`
...
class RandImputationLearner(ImputationLearner):
    ...
    Julia Equivalent:
    `IAI.RandImputationLearnerer <https://docs.interpretable.ai/v2.0.0/OptImpute/reference/#IAI.RandImputationLearner>`
