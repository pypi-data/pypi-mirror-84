...
class OptimalFeatureSelectionLearner(SupervisedLearner):
    ...
    def get_prediction_constant(self):
        ...
        Julia Equivalent:
        `IAI.get_prediction_constant <https://docs.interpretable.ai/v2.0.0/OptimalFeatureSelection/reference/#IAI.get_prediction_constant>`
    ...
    def get_prediction_weights(self):
        ...
        Julia Equivalent:
        `IAI.get_prediction_weights <https://docs.interpretable.ai/v2.0.0/OptimalFeatureSelection/reference/#IAI.get_prediction_weights>`
...
class OptimalFeatureSelectionClassifier(OptimalFeatureSelectionLearner, ClassificationLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalFeatureSelectionClassifier <https://docs.interpretable.ai/v2.0.0/OptimalFeatureSelection/reference/#IAI.OptimalFeatureSelectionClassifier>`
...
class OptimalFeatureSelectionRegressor(OptimalFeatureSelectionLearner, RegressionLearner):
    ...
    Julia Equivalent:
    `IAI.OptimalFeatureSelectionRegressor <https://docs.interpretable.ai/v2.0.0/OptimalFeatureSelection/reference/#IAI.OptimalFeatureSelectionRegressor>`
