...
_VALIDATIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='missing_cross_slices', full_name='tensorflow_model_analysis.ValidationResult.missing_cross_slices', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='validation_details', full_name='tensorflow_model_analysis.ValidationResult.validation_details', index=4,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
