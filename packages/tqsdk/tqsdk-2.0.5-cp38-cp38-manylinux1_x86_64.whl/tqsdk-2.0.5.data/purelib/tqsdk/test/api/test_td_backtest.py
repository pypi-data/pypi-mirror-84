...
class TestTdBacktest(unittest.TestCase):
    ...
    def test_sim_insert_order_time_check_1(self):
        ...
        api = TqApi(
            ...
            auth="tianqin,tianqin", _td_url=self.td_url, _md_url=self.md_url)  # 2019.12.2周一
        ...
        try:
            ...
            while order1.status != "FINISHED" or order2.status != "FINISHED" or order3.status != "FINISHED":
                api.wait_update()
            self.assertEqual(order1.order_id, "PYSDK_insert_c79d679346d4ac7a5c3902b38963dc6e")
            ...
            self.assertEqual(order2.order_id, "PYSDK_insert_43000de01b2ed40ed3addccb2c33be0a")
            ...
            self.assertEqual(order3.order_id, "PYSDK_insert_06905269ed6f0b09f165c8ce36e2f24b")
