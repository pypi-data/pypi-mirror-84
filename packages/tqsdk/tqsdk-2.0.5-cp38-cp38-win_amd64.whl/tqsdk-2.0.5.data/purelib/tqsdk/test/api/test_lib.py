...
class TestLib(unittest.TestCase):
    ...
    def test_lib_insert_order_time_check_1(self):
        ...
        api = TqApi(
            ...
            auth="tianqin,tianqin", _td_url=self.td_url, _md_url=self.md_url)  # 2020.6.3 周一
    ...
    def test_lib_insert_order_time_check_4(self):
        ...
        api = TqApi(backtest=TqBacktest(datetime.date(2020, 6, 1), datetime.date(2020, 6, 2)),
                    auth="tianqin,tianqin", _td_url=self.td_url, _md_url=self.md_url)  # 2020.6.1:周一
    ...
    def test_lib_insert_order_time_check_5(self):
        ...
        api = TqApi(backtest=TqBacktest(datetime.date(2020, 6, 2), datetime.date(2020, 6, 3)),
                    auth="tianqin,tianqin", _td_url=self.td_url, _md_url=self.md_url)  # 2019, 12, 3:周二
        symbol1 = "SHFE.cu2009"  # 有夜盘,凌晨1点结束夜盘
        symbol2 = "SHFE.rb2009"  # 夜盘23点结束
        symbol3 = "DCE.jd2009"  # 无夜盘
        quote1 = api.get_quote(symbol1)
