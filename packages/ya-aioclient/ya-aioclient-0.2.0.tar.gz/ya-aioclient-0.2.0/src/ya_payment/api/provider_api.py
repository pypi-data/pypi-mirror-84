...
class ProviderApi(object):
    ...
    def get_receive_accounts(self, **kwargs):  # noqa: E501
        """Get available accounts for receiving payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_receive_accounts(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_receive_accounts_with_http_info(**kwargs)  # noqa: E501

    def get_receive_accounts_with_http_info(self, **kwargs):  # noqa: E501
        """Get available accounts for receiving payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_receive_accounts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in local_var_params['kwargs']:
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_receive_accounts" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
