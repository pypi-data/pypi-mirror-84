...
class RequestorApi(object):
    ...
    def decorate_demand(self, allocation_ids, **kwargs):  # noqa: E501
        """Decorate market demand.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.decorate_demand(allocation_ids, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.decorate_demand_with_http_info(allocation_ids, **kwargs)  # noqa: E501

    def decorate_demand_with_http_info(self, allocation_ids, **kwargs):  # noqa: E501
        """Decorate market demand.  # noqa: E501

        Generate payment-related properties and constraints to be added to a demand published on the marketplace. As a parameter it accepts a list of IDs of allocations to be used to pay for invoices resulting from the decorated demand.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.decorate_demand_with_http_info(allocation_ids, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('allocation_ids' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `allocation_ids` when calling `decorate_demand`")  # noqa: E501
    ...
    def get_send_accounts(self, **kwargs):  # noqa: E501
        """Get available accounts for sending payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_send_accounts(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_send_accounts_with_http_info(**kwargs)  # noqa: E501

    def get_send_accounts_with_http_info(self, **kwargs):  # noqa: E501
        """Get available accounts for sending payments.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_send_accounts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in local_var_params['kwargs'].items():
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_send_accounts" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
