...
def file_traverse(path):
	#childrens = []
	#root = addNode(path.split('/')[-1], "type1", 0, 0, [get_childs(path)], 'root')
	return  {'tree' : get_childs(path)}



def folder_files_traverse(folder):
	childrens = []
...
folder = 'C:/Users/perso/Desktop/test/'
data = folder_files_traverse(folder)
f = open('C:/Users/perso/Desktop/tree3.json', 'w')
print(data)
...
data = file_traverse('C:/Users/perso/Desktop/test/f1.py')
f = open('C:/Users/perso/Desktop/tree2.json', 'w')
f.write(json.dumps( data, indent=4))
print(data)
f.close()
