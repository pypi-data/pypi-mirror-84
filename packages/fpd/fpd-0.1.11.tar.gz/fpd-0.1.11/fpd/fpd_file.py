...
class MerlinBinary:
    ...
    def write_hdf5(self, h5fn=None, chunks=None, scan_chunks=(16, 16), im_chunks=(16, 16),
        ...
        with h5py.File(h5fn, 'w', driver=None) as h5f:
            ...
            def _determine_read_chunks(fpd_dataset, byte_limit=MiB_max * 1024**2, det_im_processing=True):
                # chunk logic
            ...
            read_chunk_y, read_chunk_x = _determine_read_chunks(fpd_dataset, det_im_processing=True)
            #print(read_chunk_y, read_chunk_x)
            fpd_sum_im_dataset[:] = sum_im(fpd_dataset, read_chunk_y, read_chunk_x, progress_bar=progress_bar)
            
            read_chunk_y, read_chunk_x = _determine_read_chunks(fpd_dataset, det_im_processing=False)
            #print(read_chunk_y, read_chunk_x)
