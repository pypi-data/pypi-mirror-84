...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.GrpcGatewayListenerProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.GrpcRouteSpecProps",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.HttpGatewayListenerProps",
    jsii_struct_bases=[],
    name_mapping={"health_check": "healthCheck", "port": "port"},
)
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-appmesh.HttpRouteSpecProps",
    jsii_struct_bases=[],
