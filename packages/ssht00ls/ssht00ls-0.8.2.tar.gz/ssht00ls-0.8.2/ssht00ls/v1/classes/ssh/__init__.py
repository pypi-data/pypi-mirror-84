...
class SSHD(object):
	...
	def create(self):
		...
		# check utils intalled.
		response = self.__check_utils_installed__(list(self.users.keys()))
		if response["error"] != None: return response
		...
		#if '*all*' not in list(self.users.keys()):
...
# --------------------
# SSHD Config.
#print(sshd.__check_utils_installed__(["administrator"]))
