...
class Config():
    ...
    def load(self):
        ...
        # general config
    current_path = os.path.dirname(__file__) + "/model_assets/"
    dir_data = current_path + "data/"
    dir_output = current_path + "model/prototype_revised/"
    ...
    # glove files
    filename_glove = dir_data + "glove_s300.txt"
    # trimmed embeddings (created from glove_filename with build_data.py)
    filename_trimmed = dir_data + "glove.6B.{}d.trimmed.npz".format(dim_word)
    use_pretrained = True
    ...
    filename_words = dir_data + "words.txt"
    filename_tags = dir_data + "tags.txt"
    filename_chars = dir_data + "chars.txt"
