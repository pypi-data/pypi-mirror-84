...
from .data_utils import minibatches, pad_sequences, create_tag_dict
...
class NERModel(BaseModel):
    ...
    def add_loss_op(self):
        ...
        if self.config.use_crf:
            ...
            self.trans_params = trans_params  # need to evaluate itfor decoding
    ...
    def run_evaluate(self, test):
        ...
        f1 = f1_score(labels, preds,
                      average='micro',
                      labels=['JURISPRUDENCIA', 'LOCAL', 'TEMPO',
                              'PESSOA', 'LEGISLACAO', 'ORGANIZACAO'])
