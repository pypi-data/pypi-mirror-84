...
appname = 'StruthonSteelMember'

version = '0.0.2 (alpha version for testing)'
...
You should have received a copy of the GNU General Public License along with Struthon; if not, write to the Free Software Foundation, Inc., 51 Franklin St, Fifth Floor, Boston, MA  02110-1301  USA.

Copyright (C) 2015-2020 Lukasz Laba (e-mail : lukaszlaba@gmail.com)
-------------Project info-------------
