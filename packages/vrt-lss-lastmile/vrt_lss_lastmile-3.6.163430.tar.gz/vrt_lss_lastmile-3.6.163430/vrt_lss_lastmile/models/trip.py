...
class Trip(object):
    ...
    def __init__(self, key=None, assigned_shifts=None, actions=None, waitlist=None, start_location_key=None, finish_location_key=None, comment=None, local_vars_configuration=None):  # noqa: E501
    ...
    def comment(self, comment):
        """Sets the comment of this Trip.

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :param comment: The comment of this Trip.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
