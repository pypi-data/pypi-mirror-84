...
class Performer(object):
    ...
    def __init__(self, key=None, max_work_shifts=31, performer_features=[], transport_restrictions=None, own_transport_type=None, comment=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this Performer.  # noqa: E501

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :return: The comment of this Performer.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this Performer.

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :param comment: The comment of this Performer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
