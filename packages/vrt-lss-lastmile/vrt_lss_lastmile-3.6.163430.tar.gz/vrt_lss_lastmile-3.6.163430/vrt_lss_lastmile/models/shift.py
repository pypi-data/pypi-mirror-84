...
"""
    ...
    The version of the OpenAPI document: 3.6.163430
...
class Shift(object):
    ...
    def __init__(self, key=None, shift_type=None, resource_key=None, availability_time=None, working_time=None, start_location_key=None, finish_location_key=None, tariff=None, comment=None, local_vars_configuration=None):  # noqa: E501
    ...
    def comment(self, comment):
        """Sets the comment of this Shift.

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :param comment: The comment of this Shift.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
