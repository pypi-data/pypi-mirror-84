...
class Order(object):
    ...
    def __init__(self, key=None, order_features=None, order_restrictions=None, performer_restrictions=[], performer_blacklist=[], cargos=None, demands=None, comment=None, local_vars_configuration=None):  # noqa: E501
