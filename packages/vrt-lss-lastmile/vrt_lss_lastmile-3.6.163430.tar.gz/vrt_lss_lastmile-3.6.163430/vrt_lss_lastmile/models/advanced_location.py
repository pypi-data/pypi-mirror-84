...
class AdvancedLocation(object):
    ...
    def __init__(self, key=None, location=None, transport_restrictions=None, load_windows=None, comment=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this AdvancedLocation.  # noqa: E501

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :return: The comment of this AdvancedLocation.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this AdvancedLocation.

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :param comment: The comment of this AdvancedLocation.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
