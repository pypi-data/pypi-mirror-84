...
class Demand(object):
    ...
    def __init__(self, key=None, demand_type=None, target_cargos=None, precedence_in_trip=0, precedence_in_order=0, possible_events=None, comment=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def comment(self):
        """Gets the comment of this Demand.  # noqa: E501

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :return: The comment of this Demand.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this Demand.

        Comment, used to indicate service information that does not affect planning.  # noqa: E501

        :param comment: The comment of this Demand.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
