...
from project.utils.viewsets import CustomModelViewSet, TreeAPIView
from project.utils.func import get_tree, get_tree_menu
...
class CurrentUserAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response({**user, 'avatar': 'https://cpa-global.oss-cn-beijing.aliyuncs.com/cpa-global-logo.png'})
