...
class FaciesProperties(PdmObjectBase):
    ...
    def __init__(self, pb2_object=None, channel=None):
        self.color_legend = "ColorLegend:1957050571712"
        self.file_path = ""
        self.properties_table = ""
        PdmObjectBase.__init__(self, pb2_object, channel)
...
class FractureModel(CheckableNamedObject):
    """
    Attributes:
    ...
    def __init__(self, pb2_object=None, channel=None):
        ...
        CheckableNamedObject.__init__(self, pb2_object, channel)
        if FractureModel.__custom_init__ is not None:
            FractureModel.__custom_init__(self, pb2_object=pb2_object, channel=channel)
...
class FractureModelCollection(CheckableNamedObject):
    ...
    def fracture_models(self):
        """
        Returns:
             List of FractureModel
        """
        return self.children("FractureModels", FractureModel)
    ...
    def new_fracture_model(self, well_path=None, measured_depth=None, fracture_model_template=None):
        ...
        Arguments:
            ...
            measured_depth (float): Measured Depth
            fracture_model_template (FractureModelTemplate): Fracture Model Template
        Returns:
            FractureModel
        """
...
class FractureModelPlotCollection(PdmObjectBase):
    ...
    def new_fracture_model_plot(self, eclipse_case=None, fracture_model=None, time_step=None):
        ...
        Arguments:
            ...
            fracture_model (FractureModel): Fracture Model
            time_step (int): Time Step
        Returns:
            FractureModelPlot
        """
...
class FractureModelTemplate(PdmObjectBase):
    """
    Attributes:
    ...
    def __init__(self, pb2_object=None, channel=None):
        ...
        PdmObjectBase.__init__(self, pb2_object, channel)
        if FractureModelTemplate.__custom_init__ is not None:
            FractureModelTemplate.__custom_init__(self, pb2_object=pb2_object, channel=channel)
...
class FractureModelTemplateCollection(PdmObjectBase):
    ...
    def fracture_model_templates(self):
        ...
        Returns:
             List of FractureModelTemplate
        """
        return self.children("FractureModelTemplates", FractureModelTemplate)
...
def class_dict():
    ...
    classes['FractureModel'] = FractureModel
    ...
    classes['FractureModelTemplate'] = FractureModelTemplate
