...
silent only
cd /home/www.django/codenerix/django-codenerix/codenerix/templates
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 /home/www.django/codenerix/django-codenerix/codenerix/views.py
argglobal
silent! argdel *
argadd /home/www.django/codenerix/django-codenerix/codenerix/views.py
edit /home/www.django/codenerix/django-codenerix/codenerix/views.py
...
set list
setlocal list
setlocal makeprg=prospector\ -8\ -o\ pylint\ %
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
...
setlocal tabstop=8
setlocal tagcase=
setlocal tags=./tags,./TAGS,tags,TAGS,.git/tags,/home/www.django/codenerix/django-codenerix/.git/tags
...
let s:l = 350 - ((12 * winheight(0) + 17) / 35)
