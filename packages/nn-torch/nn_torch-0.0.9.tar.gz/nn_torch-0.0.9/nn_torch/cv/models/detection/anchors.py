...
def min_wh2min_max(bbox: torch.Tensor) -> torch.Tensor:
    bbox[..., 2] += bbox[..., 0]
    bbox[..., 3] += bbox[..., 1]
    return bbox


def min_wh2cwh(bbox: torch.Tensor) -> torch.Tensor:
    bbox[..., 0] += bbox[..., 2] / 2
    bbox[..., 1] += bbox[..., 3] / 2
    return bbox


def cwh2min_wh(bbox: torch.Tensor) -> torch.Tensor:
    bbox[..., 0] -= bbox[..., 2] / 2
    bbox[..., 1] -= bbox[..., 3] / 2
    return bbox


def cwh2min_max(bbox: torch.Tensor) -> torch.Tensor:
    return min_wh2min_max(cwh2min_wh(bbox))


def min_max2min_wh(bbox: torch.Tensor) -> torch.Tensor:
    bbox[..., 2] -= bbox[..., 0]
    bbox[..., 3] -= bbox[..., 1]
    return bbox


def min_max2cwh(bbox: torch.Tensor) -> torch.Tensor:
